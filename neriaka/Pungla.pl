...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Welcome! Drink you shall, some of de finest drinks of da lands! [" . quest::saylink("What is Flaming Pungla?",0,"Flaming Pungla") . "] I suggest to you. It all me sells.");
