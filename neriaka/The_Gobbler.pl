...
sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Meat!! You need meat. Me gots meat!! High elf meat, dwarf meat, human meat, [" . quest::saylink("What is HEHE meat?",0,"HEHE meat") . "], [" . quest::saylink("What are froggy legs?",0,"froggy legs") . "]. Me got a lot.");
	}
		...
		quest::say("Froggy legs come from far away. Me get from friend, [" . quest::saylink("Who is Chef Dooga?",0,"Chef Dooga") . "]. It not tasty. Trolls like it. Eat it up much. They eat too much froggy. Me glad [" . quest::saylink("Who is Nerbilik?",0,"Nerbilik") . "] leave Neriak!! He eat way too much froggy.");
	}
	elsif ($text=~/chef dooga/i) {
		quest::say("Friend in Oggok is Chef Dooga. Chef she is. Used to work in Neriak. She beautiful. She supply the Gobbler with [" . quest::saylink("What froglok legs?",0,"froglok legs") . "]. They very low now. Fat trolls eat too many!! Me need to [" . quest::saylink("I will pick up froglok legs",0,"pick up froglok legs") . "].");
	}
		...
		quest::say("Big and fat troll Nerbilik is. He leave to fish in tearsy ocean. Me promised to deliver him food or he come bak. The Gobbler needs some dumb person to [" . quest::saylink("I will deliver grub locker",0,"deliver grub locker") . "] to Nerbilik.");
	}
