sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Me Uglan. Mighty ogre. Member of Crakneks. We crush for dark elves. Do you [" . quest::saylink("I like dark elves",0,"like dark elves") . "] or they be [" . quest::saylink("They are mean to me",0,"mean") . "] to you?");
