...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Welcome. my friend! We are the Craftkeepers. We study the circle of magic called enchantment. What circle do you [" .. eq.say_link("I study enchantment",false,"study") .. "]?");
