...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Come forward and speak.  What is it you seek within these walls?  Let it be the knowledge of wizardry. for that is what we are.  Only a [" .. eq.say_link("servant of wizardry") .. "] should be within these walls.");
	elseif(e.message:findi("servant of wizardry")) then
		e.self:Say("A servant. you say?  If you be a young apprentice. perhaps you might assist me? I could use you to [" .. eq.say_link("collect components") .. "].  If you believe yourself to be beyond such things. you may wish to assist me with a [" .. eq.say_link("special matter") .. "].");
