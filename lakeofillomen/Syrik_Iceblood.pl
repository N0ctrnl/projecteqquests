...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Oh, hello. You caught me while I was in thought. Currently I am researching the methodology used in smithing weapons during the age of [" . quest::saylink("Veksar") . "]. If you wish to help, let me know. I will take any [" . quest::saylink("help") . "] available, be it friend or foe to the legions of Cabilis.");
  }
  if ($text=~/help/i) {
  ...
  if ($text=~/veksar/i) {
    quest::say("Veksar was an opulent resort enjoyed by privileged nobles and generals of the empire. It was built near a small freshwater spring with legendary restorative properties, this small outpost was considered one of the finest treasures of the realm. Highly-ranked Iksar from the empire came here to cure their illness and extend their lives with the mystical [" . quest::saylink("waters") . "]. This town was originally created by the Kylong tribe of Iksar, but was assimilated into the ranks of Venril Sathir when he united the five tribes. Many [" . quest::saylink("legendary Iksar") . "] lived there.");
  }
  if ($text=~/legendary iksar/i) {
    quest::say("When the Kunzar armies marched upon the Kylong, the three greatest Kylong mystics shattered the medallion of Kylong, a holy relic of their tribe, and fled their mountain homes in order to prevent the Kunzar from reassembling it. These three Kylong were [" . quest::saylink("Verix Kylox") . "], [" . quest::saylink("Dakon Sythrax") . "], , and [" . quest::saylink("Sirk Vemat") . "]. As they fled from their tribe they knew that the chances to form the medallion together would be less if the Kylong split up. Verix attempted to hide in the hills of the Dreadlands. Dakon headed north to the Field of Bone. Sirk Vemat headed to the Burning Woods to hide in the forest.");
  }
  ...
  if ($text=~/waters/i) {
    quest::say("Veksar was guarded from the constant attack of dragons and the skulking bands of goblins living in the nearby hills. For years the city thrived with all sorts of visitors. Soldiers harmed by the war were sent there to mend their wounds. High-ranking officials came here to relax and escape the tedium of war. Even Iksar commoners came here desperate to cure whatever ailed them. Since the war with the dragons was always escalating, a massive dome was built overhead to keep the attacks of the dragons away. In spite of efforts, the [" . quest::saylink("dragons") . "] found a way to attack.");
  }
  if ($text=~/dragons/i) {
    quest::say("Trakanon sent many dragons here to scout out why this town was so popular. After learning about the Iksar being healed, he know that he had to take action on the city. He formed a plan to first cripple the cities walls so that their own dome would trap them, and then flood the water of the healing spring. This would not only trap them, but also dilute the waters, preventing any further healing from taking place. [" . quest::saylink("Garudon") . "] would lead in the direct attack of the town.");
  }
  if ($text=~/garudon/i) {
    quest::say("During the formation of Trakanon's ranks he did not garner the support he desired. One of the first dragons to come to his side was Garudon. He quickly grew to be Trakanon's most trusted ally, and aided in drawing support from the dragon ranks. Because of his high ranking position Garudon would lead the [" . quest::saylink("fight") . "] against Veksar.");
  }
  if ($text=~/fight/i) {
    quest::say("The Dragons clawed at the supporting pillars of the dome. The town began to shake and the dome began to fall. The Dragons fled from the pillars, but one was trapped. Garudon was caught in a snare set up by the town's defense. Crumbling to the ground the dome sealed their fate. Garudon fought with the Iksar from under the dome with no hope of escaping. The Dragons then called upon the waters to flow, and flood the valley. The spring was flooded, its magical properties lost forever. The soldiers finally brought down Garudon. With his last breath he let out a flame that scorched much of the dome and then fell from the air, crashing through the ceiling of the theater that was built to entertain the Iksar on the mend. Most of his [" . quest::saylink("bones") . "] still remain there, while others were ground up in necromantic ceremonies.");
  }
  if ($text=~/bones/i) {
