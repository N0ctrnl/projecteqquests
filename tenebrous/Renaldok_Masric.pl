...
sub EVENT_SAY { 
  if($text=~/Hail/i){
    quest::say("Greetings mortal. The aura of death that surrounds you is the only reason you are not already a feast for my minions. Have you come to me as a sacrifice or are you offering your [" . quest::saylink("I offer my services",0,"services") . "] to the Coterie of the Eternal Night?");
  }
  if($text=~/services/i){
