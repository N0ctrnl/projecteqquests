...
sub EVENT_SAY {
   ...
   if($text=~/Hail/i){
      quest::say("Hail, $name. I am Darfumpel, master jeweler and proprietor of this shop. How might I assist you today? Perhaps you need a stone [" . quest::saylink("I need a stone cut",0,"cut") . "] or some jewelry [" . quest::saylink("I need jewelry repaired",0,"repaired") . "]?");
   }
   if($text=~/cut/i){
