...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Greetings! I am the holder of the secret of the [" . quest::saylink("What Breastplate of Ro?",0,"Breastplate of Ro") . "]. You may rest here. You are quite safe within this camp of paladins.");
  }
  elsif ($faction > 5) {
    ...
    quest::say("You need to prove your loyalty to my temple. Go to Felwithe and seek out the Clerics of Tunare. Prove to them your faith. Then ask the leader of this church if you are a [" . quest::saylink("",0,"") . "][honored member].");
  }
