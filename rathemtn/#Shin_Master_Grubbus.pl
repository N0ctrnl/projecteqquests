...
sub EVENT_SAY {
  ...
  if ($text=~/paladin/i) {
    quest::say("Very good. Initiates of the Knighthood of Marr must pass a series of tests. If you are devout and loyal to our cause you will be rewarded with our [" . quest::saylink("What ceremonial armor?",0,"ceremonial armor") . "].");
  }
  if ($text=~/ceremonial armor/i) {
    quest::say("We, the Shin Initiates, play an important role as mentors, healers, and warriors against evil in the Guktan Army. As a Shin Initiate all your battles should be fought in Marr's name. To show your homage to both Mithaniel Marr and our fellow brethren in the Guktan Army, young initiates are encouraged to complete a series of tasks that, when completed, will grant a set of Shin Initiate Armor. This armor shows your dedication and commitment to our cause. If you truly wish to walk in the path of The Truthbringer, I strongly suggest you complete your set of armor before venturing too far outside of the swamp. Are you [" . quest::saylink("I am ready to begin",0,"ready to begin") . "]?");
  }     
  if ($text=~/ready to begin/i) {
    quest::say("Take this assembly kit. When you combine various items together in the assembly kit, you can create the different pieces of armor that you will need, such as [" . quest::saylink("helm",0,"helm") . "], [" . quest::saylink("armguards",0,"armguards") . "], [" . quest::saylink("breastplate",0,"breastplate") . "], [" . quest::saylink("bracers",0,"bracers") . "], [" . quest::saylink("gauntlets",0,"gauntlets") . "], [" . quest::saylink("legplates",0,"legplates") . "], and [" . quest::saylink("boots",0,"boots") . "]. If you would like to start crafting your armor, just tell me what piece you would like to craft and I will give you further instructions.");
