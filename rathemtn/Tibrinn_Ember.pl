...
sub EVENT_SAY {
   ...
   if($text=~/Hail/i){
      quest::say("I am Tibrinn Ember, forest friend and Unkempt Druid. Aid us in our [" . quest::saylink("What conflict?",0,"conflict") . "] against the polluters of nature and I will reward you.");
   }
   if($text=~/conflict/i){
