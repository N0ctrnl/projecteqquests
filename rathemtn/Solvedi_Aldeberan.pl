...
sub EVENT_SAY {
   ...
   if($text=~/Hail/i){
      quest::say("Hail, forestwalker. Welcome to the Rathe bear preserve of the Unkempt Druids. We strive to protect nature with diligence and punish her [" . quest::saylink("What defilers?",0,"defilers") . "] with prejudice!");
   }
   if($text=~/defilers/i){
