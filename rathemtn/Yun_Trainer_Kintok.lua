	...
	if (e.other:Class() == "Shaman" and e.other:Race() ==  "Froglok") then
		if (e.message:findi("hail")) then
			...
			elseif (my_globals["guktan_shield"] == "1") then
				e.self:Say("Ahh, so you have returned to me with your shield. It appears to have gotten some good use in the recent months. Before I can get to work on your shield, I need a few components. Would you mind [" .. eq.say_link("I don't mind retrieving the components",false,"retrieving the components") .. "] for me?");
			elseif (my_globals["guktan_shield"] == "2") then
				e.self:Say("You sure are rough on shields, arent you?! No matter, I am sure that I can reinforce the shield enough to get you a few more years out of it, but this wont be easy. I have been expecting a shipment of supplies that have not yet arrived. The shipment left Erudin last week, but I've not received it, and I fear the worst for my assistant. If you are [" .. eq.say_link("I am up to the task",false,"up to the task") .. "], I could certainly use you to research the problem, and in exchange for your services I will upgrade your shield one final time.");
			end
		elseif (e.message:findi("shield")) then
			e.self:Say("It's quite simple and surprisingly effective. Bring me some [" .. eq.say_link("Stretched Kobold Leather",false,"Stretched Kobold Leather") .. "], a [" .. eq.say_link("Bundle of Faydark Twigs",false,"Bundle of Faydark Twigs") .. "], a [" .. eq.say_link("Bundle of Thicket Twigs",false,"Bundle of Thicket Twigs") .. "], and some [" .. eq.say_link("Leathery Twine",false,"Leathery Twine") .. "] and I'll weave you one in a frog's blink. It is the least I can do for a fellow spiritist.");
		...
		elseif (e.message:findi("retrieving the components")) then
			e.self:Say("A brave young initiate, indeed. This task may prove to be a bit daunting, but the items I require are quite rare, and are not available in this section of the world. Return to me with a [" .. eq.say_link("What chunk of prismatic metal?",false,"chunk of prismatic metal") .. "], a [" .. eq.say_link("What chunk of refined metal?",false,"chunk of refined metal") .. "], a [" .. eq.say_link("What shield frame mold?",false,"shield frame mold") .. "], in addition to your initiates shield, and then I will get to work rebuilding your shield for you!");
