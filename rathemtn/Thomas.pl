...
sub EVENT_SAY {
  if ($faction > 5) {
    ...
    if ($text=~/hail/i) {
      quest::say("Welcome to our camp. We are paladins gathered from many lands. We have been called to this land by our deities. Ours is a crusade of righteousness. Have you happened upon us by chance or do you [" . quest::saylink("I seek the sacred molds",0,"seek the sacred molds") . "]?");
    }
    elsif ($text=~/seek the sacred molds/i) {
      quest::say("Many of us carry the sacred molds of the holy paladin armor. We will release it only to those who have proven themselves to each of our deities. If you seek it, speak up!! Tell us which part you seek. I carry the secret of the [" . quest::saylink("What Helm of Ro?",0,"Helm of Ro") . "]. The others carry those of vambraces, breastplates, bracers, gauntlets, greaves and boots of Ro.");
    }
    elsif($text=~/ronium/i) {
      ...
      quest::say("Lord Searfire is a great forge master. He was called forth to the land of fire lakes. It is said that he now toils in the name of Solusek Ro within a hidden temple of that land. He and he alone knows how to obtain [" . quest::saylink("What is ronium?",0,"ronium") . "], a needed component for forging the sacred Armor of Ro.");
    }
  }
}
...
sub EVENT_ITEM { 
  if ($client->GetModCharacterFactionLevel(280) > 24) {  # amiable or better to get mold
    if (plugin::check_handin(\%itemcount, 12308 => 2)) {
      quest::say("You have proven yourself to Karana. I grant you the mold of the Ro Helm. May the winds of Karana blow in your favor. Now you must seek out [Lord Searfire] and ask him for [" . quest::saylink("What is ronium?",0,"ronium") . "] to complete the second and only other component needed to be fashioned by a master blacksmith.");
