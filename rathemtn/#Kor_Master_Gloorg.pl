...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Welcome back, young Kor. I hope your training is going well. Unfortunately I have been unable to keep up to date on your progress, but should you need advanced training in any individual skills, I am here to help you with that. As well, I am here to guide you through your growth as a Cleric in the Guktan Army. With the skills that you learn here, you will be better prepared to serve the Army. If you do indeed plan on following the path of a [" . quest::saylink("I am a cleric",0,"Cleric") . "], I have some tasks that you will need to complete, if it suits your interest.");
  }
  if ($text=~/cleric/i) {
    quest::say("Excellent! I will give you a list of items to collect, and then combine in this magical assembly kit. This will create a material that you will use to craft a suit of armor that will protect you from the various dangers of Norrath, for years to come. If you are ready to begin your task, I will give you the assembly kit, as well as instructions for collecting the necessary items to craft your armor. Are you ready to receive your [" . quest::saylink("What assembly kit?",0,"assembly kit") . "]?'");
  }
  
  if ($text=~/assembly kit/i) {
    quest::say("Here you are $name, take this assembly kit, it is what you will use to combine the different items required to craft your own Kor Initiate's armor. Different items will be required to craft the different pieces of armor. These items will be available from both our outpost, as well as the training grounds near here. When you are ready to receive a recipe for a specific material, simply tell me which armor piece you wish to craft. I hold the recipe's for Kor Initiates [" . quest::saylink("Helms",0,"Helms") . "], [" . quest::saylink("Bracers",0,"Bracers") . "], [" . quest::saylink("Boots",0,"Boots") . "], [" . quest::saylink("Armguards",0,"Armguards") . "], [" . quest::saylink("Legplates",0,"Legplates") . "], [" . quest::saylink("Gloves",0,"Gloves") . "], and [" . quest::saylink("Breastplates",0,"Breastplates") . "]. Keep in mind that the items required to make some of the larger pieces of armor will be a bit more difficult to get. You may want to wait until you are more experienced before attempting to obtain the components.");
