...
sub EVENT_SAY {
 if($text=~/hail/i){
  quest::say("Eh, hrm? Who're you? Found yer way in here, 'ave ya? Not the brightest idea in the world, ya know. I hope you weren't planning on going any further, because that would really be on the level of those twerps that freed that [" . quest::saylink("What shiny beast?",0,"shiny beast") . "] in the first place.");
  }
