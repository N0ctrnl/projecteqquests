...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Welcome. Please stock up on provisions, especially if you are headed toward the lair of the vile gnolls. If so, I wish you much luck and many gnoll pelts!! I also have knowledge of a [" .. eq.say_link("What powerful dog?",false,"powerful dog") .. "]. I pray you do not encounter him.");
	elseif(e.message:findi("powerful dog")) then
		e.self:Say("I have encountered a gnoll who spoke the common tongue. He dared to call himself Lord Elgnub. He swore that some day we would cross paths and he would snatch my infant son Joseph from our home. He would stand no chance against me and the mighty [" .. eq.say_link("What is Gnoll Slayer?",false,"Gnoll Slayer") .. "].");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 12204})) then
		e.self:Say("Baby Joseph!! Look, Momma!! Baby Joseph has been rescued by this good adventurer!! That evil Lord Elgnub made good on his word and snatched my son from under our noses. You saved the day!! For this you shall wield 'Gnoll Slayer'!! Be aware of its [" .. eq.say_link("What true potential?",false,"true potential") .. "].");
