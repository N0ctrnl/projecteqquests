...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Well, it seems that you have something of importance that you wish to speak to me about? No? Then perhaps you can do something [" .. eq.say_link("I will do something for you",false,"for me") .. "].");
	elseif(e.message:findi("for you")) then
		e.self:Say("Well I need some information. It appears that some gnolls are planning an [" .. eq.say_link("What invasion?",false,"invasion") .. "] of Surefall. I believe there are some gnoll couriers that are running information. If you could bring me their marching orders, invasion plans, area maps, and their encryption key. Your best chance to catch a courier is probably inside Blackburrow.");
