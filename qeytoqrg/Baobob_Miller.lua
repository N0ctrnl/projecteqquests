...
function event_say(e)
	...
	if(fac < 6) then
		if(e.message:findi("hail")) then
			e.self:Say("Hello, there. My name is Baobob Miller. My [" .. eq.say_link("Who is your sister?",false,"sister") .. "] and I are the best tanners in all of Norath. Wolves are my specialty. A nice wolf skin [" .. eq.say_link("What garment?",false,"garment") .. "] would be the perfect accessory to your stylish ensemble.");
		...
		elseif(e.message:findi("garment")) then
			e.self:Say("I make the finest wolf skin [" .. eq.say_link("boots",false,"boots") .. "],[" .. eq.say_link("cloaks",false,"cloaks") .. "] and [" .. eq.say_link("belts",false,"belts") .. "] in all of Antonica.");
