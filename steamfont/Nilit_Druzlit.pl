sub EVENT_SAY { 
  if($text=~/Hail/i){
    quest::say("Eh?  Eh?!  Talk not now!  My [" . quest::saylink("What creation?",0,"creation") . "] is running wild!  Destroy it for me. please!  If you do you can keep whatever parts you want from it.");
  }
  if($text=~/what creation/i){
