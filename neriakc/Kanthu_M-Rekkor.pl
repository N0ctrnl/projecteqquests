...
sub EVENT_SAY {
  ...
  if($text=~/materials/i) {
    quest::say("Many species of dangerous creatures, the restless dead, and halfling invaders from Rivervale inhabit the Nektulos Forest. You must defeat these creatures and halflings in order to obtain the materials. The materials you seek depend on the piece of armor you desire. Do you desire to craft [" . quest::saylink("gloves") . "], [" . quest::saylink("boots") . "], a [" . quest::saylink("bracer") . "], a [" . quest::saylink("coif") . "], [" . quest::saylink("leggings") . "], [" . quest::saylink("sleeves") . "], or a [" . quest::saylink("tunic") . "]?");
