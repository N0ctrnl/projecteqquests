...
sub EVENT_SAY { 
  if($text=~/Hail/i){
    quest::say("What is this I see before me? A would-be hero of the Dead? You reek of false bravado. I have seen others much stronger than you meet their fate at the end of a blade. I see no reason to continue our conversation. How can one such as you assist with my [" . quest::saylink("What delegated duties?",0,"delegated duties") . "]?");
  } elsif($text=~/delegated duties/i){
    quest::say("Why do you ask? I know why. Glory has captured your affections. Those who seek glory find death. Still, you may be of some use. Before I assign you a task, I must be assured of your power. I require you to [" . quest::saylink("I will perform a test",0,"perform a test") . "].");
  } elsif($faction > 5){
...
sub EVENT_ITEM{
  my $deadfaction = $client->GetModCharacterFactionLevel(239); # Faction: The Dead
  if ($faction < 5) {
    if($deadfaction > 149 && plugin::check_handin(\%itemcount, 18828 => 1)) {
      quest::say("So you have succeeded where others have failed. You show promise. Take this then. You shall be a valuable asset to the Dead and soon this shall be of value to one so great. This will help you on your way. Are you still interested in my [" . quest::saylink("What appointed tasks?",0,"appointed tasks") . "]?");
      ...
      quest::say("I see my expeditionary unit has encountered problems. I must send a dragoon unit to Befallen at once. I must not allow the [" . quest::saylink("What Thex Mallet?",0,"Thex Mallet") . "] to fall into the hands of some simple adventurer. Here is payment for your quick service.");
