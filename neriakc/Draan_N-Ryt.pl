sub EVENT_SAY {
  if($text=~/hail/i) {
    quest::say("I am Draan N'Ryt, provider of the purest [" . quest::saylink("What adamantite ore?",0,"adamantite ore") . "] and master smith of [" . quest::saylink("What adamantite chainmail?",0,"adamantite chainmail") . "]!");
  }
