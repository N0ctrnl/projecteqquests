...
sub EVENT_SAY { 
  if ($text=~/hail/i){
    quest::say("Greetings, disciple $name. Feel free to inspect my wares. I am here to serve all necromancers of the Dead. I can also enchant a [" . quest::saylink("What Ring of the Dead?",0,"Ring of the Dead") . "] if you have one.");
