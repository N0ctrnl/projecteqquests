...
sub EVENT_SAY {
  if($text=~/hail/i) {
    quest::say("Greetings child, what business do you have here? I'm sorry but I will only deal with Clerics that are willing to prove their loyalty to Innoruuk. I cannot deal with every single heathen that feels it is necessary to bid me a good day. If you are a [" . quest::saylink("I am a Cleric of Innoruuk",0,"Cleric of Innoruuk") . "] I might be able to aid you in your training.");
  }
  if(($class eq "Cleric") && ($race eq "Dark Elf")) {
    if($text=~/cleric of innoruuk/i) {
      quest::say("Is that so $race $name. Well from the looks of you I wouldn't say you are much of anything yet. However, if you have the willingness and determination to serve your God then there might just be more hope for you then I would have thought. Obviously, to move forward in your training, you will need to shield yourself from your enemies and from the elements. I believe I have something that could help you if you are still [" . quest::saylink("I am interested in proving myself",0,"interested in proving yourself") . "]");
    }
    if($text=~/interested in proving myself/i) {
      quest::say("Well I must say that I am impressed by your eagerness to learn, however, you are not the first and will not be the last I am sure that has sworn devotion to our Lord Innoruuk. Lets just hope you don't end up in the burial grounds where many promising young ones before you have found their resting place. If you are ready to begin gathering items to fashion your very own Initiate Darkpriest Armor then I will present you with a [" . quest::saylink("What magical relic?",0,"magical relic") . "].");
    }
    if($text=~/magical relic/i) {
      quest::say("I have a box that I have been keeping for quite some time and have been waiting to present it to someone like yourself. Someone that I had faith would be strong enough to use it's power to their benefit. This magical box can be used to refine certain metals into a magical compound that is used in crafting Initiate Darkpriest armor pieces. I have the molds necessary to craft Initiate Darkpriest [" . quest::saylink("Helms") . "], [" . quest::saylink("Bracers") . "], [" . quest::saylink("Boots") . "], [" . quest::saylink("Armguards") . "], [" . quest::saylink("Greaves") . "], [" . quest::saylink("Gauntlets") . "] and [" . quest::saylink("Breastplates") . "]. However there are some [" . quest::saylink("What important items?",0,"important items") . "] that you will need to collect before the molds will be of any use to you. One thing to keep in mind is that I suggest you craft your Breastplate last due to the difficulty of obtaining the items needed for that specific recipe.");
      quest::summonitem(17245); #Dark Blessed Box
    }
    if($text=~/important items/i) {
      quest::say("There are certain items that will need to be gathered in our great city of Neriak along with many different things gathered outside in the Forest of Nektulos, where most of your training will take place. The most important component that you will need to collect while adventuring in the forest are Helms that are only worn by Priests of Rodcet Nife. These vile creatures have set up camp in the forest from what I have heard and it is your responsibility to find and execute them. These helms will be your most important component that you will gather because it is used in all [" . quest::saylink("What armor recipes?",0,"armor recipes") . "] as the metal that you will forge your armor with.");
    }
