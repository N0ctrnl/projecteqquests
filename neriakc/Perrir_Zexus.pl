...
sub EVENT_SAY {
  if($faction >5) {
    ...
    quest::say("Salutations, $name! Your devotion to our Lord Innoruuk is evident in your actions and on your soul. As a member of the Spires of Innoruuk, you are required to obtain and wear the symbol of your station among the clergy. I can award you the [" . quest::saylink("What hematite symbol of Innoruuk?",0,"hematite symbol of Innoruuk") . "] worn by the initiates of the Spires.");
  }
