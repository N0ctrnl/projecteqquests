...
sub EVENT_SAY {
  ...
  if($text=~/dark arts/i) {
    if($class eq "Necromancer" && $ulevel >= 50) {
      quest::emote("looks you up and down, his eyes glowing with a soft red light. After a moment he begins to speak though his lips do not move. 'You wish to study under me? Perhaps, if you [" . quest::saylink("How can I prove myself?",0,"prove yourself") . "] to follow the twisted path. If you prove to be as coldhearted as I then I will let you become my servant.'");
    }
    else {
