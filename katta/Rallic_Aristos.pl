...
sub EVENT_SAY {
  if($text=~/Hail/i){
    quest::say("Well met $name! I am Rallic Aristos. Governor of trade and economy here in Katta Castellum. I know it sounds like a lot of parchment pushing and coin counting but maintaining good trade relations with the various Houses of Shadow Haven and the haggling Vah Shir of Shar Vahl is not as easy at it may sound. Then there is the issue of the [" . quest::saylink("What acrylia mines?",0,"acrylia mines") . "] in the Tenebrous Mountains.");
  }
  if($text=~/acrylia mines/i){
    quest::say("The Tenebrous Mountains are rich with veins of the valuable acrylia ore. Unfortunately the mines were dug and controlled by a tribe of savage grimlings from the forests to the south. Negotiations have been attempted with the grimlings but to no avail. Several of the other governors and I have been developing a [" . quest::saylink("What plan?",0,"plan") . "] to take the mines or establish mines of our own. In either case the mines will have to be defended from attacks by the grimlings unless when placed in that predicament they finally resort to trade negotiations.");
  }
  if($text=~/plan/i){
...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 31730 => 1)){
    quest::say("Excellent. The contents of the pouch shall be examined immediately. Take this pattern for a crafting a pack that will be sure to lighten the burden of its contents. I'm afraid I do not have the rest of the [" . quest::saylink("What are the required materials?",0,"required materials") . "] at hand.");
