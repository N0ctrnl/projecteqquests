...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Well met, kind $race. I am Governor Toktonn Geerlok of the Loyalist Combine. It is my duty to oversee all matters concerning engineering, construction, and maintenance within Katta Castellum. There is a wonderful ore native to Luclin called [" . quest::saylink("What is Acrylia?",0,"Acrylia") . "] that has proved to be a valuable asset to my crew and I.");
  }
  if ($text=~/acrylia/i) {
