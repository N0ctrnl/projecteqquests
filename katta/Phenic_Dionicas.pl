...
sub EVENT_SAY{
  if($text=~/hail/i){
    quest::say("Greetings adventurer. I am Phenic Dionicas, Magistrate of the Loyalist Combine Empire. I hope the [" . quest::saylink("What vampyres?",0,"vampyres") . "] did not cause you troubles on your journey here. ");
  }
  if($text=~/vampyres/i){
    quest::say("Aye, the vampyres of the Coterie of the Eternal Night. I was among the first to ever [" . quest::saylink("discover") . "] the vampyre threat when I was just a young boy freshly initiated into the [" . quest::saylink("What is the Validus Custodus?",0,"Validus Custodus") . "].");
  }
  if($text=~/discover/i){
    quest::say("I was on a routine trade route patrol through the tenebrous mountains and the grimling forest when we were attacked by a pack of the vile undead. The creatures that attacked us wore the garments of Shadow Haven merchants and nearly my entire patrol was slain by their claws and fangs. Only [" . quest::saylink("Who is Heratius Grolden?",0,"Heratius Grolden") . "] and myself made it back to the safety of Katta Castellum alive and shortly after I was the only survivor of the attack.");
  }
  ...
  if($text=~/Heratius Grolden/i){
    quest::say("Heratius Grolden was a boyhood friend of mine and a brave legionnaire in the Validus Custodus. He was buried with honor in the graveyard of Katta Castellum. Several nights after his burial Heratius' grave had been dug up and his body was missing. I suspect and fear that the Coterie of the Eternal Night returned for him to make him one of their own. I pray to whatever gods are listening that some day we are able to [" . quest::saylink("I will track down the defilers",0,"track down the defilers") . "]!");
  }
...
sub EVENT_ITEM{
  if(plugin::check_handin(\%itemcount, 18330 => 1)){
    ...
    quest::say("Most interesting. One of the names on this list I recognize. The alchemist [" . quest::saylink("Who is Valdanov Zevfeer?",0,"Valdenov Zevfeer") . "]. Nathyn Illuminious would know more of Valdanov. Present this badge to Nathyn so that he knows you have been sent by the Magistrates to inquire about this issue and question him about the alchemist.");
    quest::ding();
    quest::faction(1561,2); # Faction: Concilium Universus
    quest::faction(1483,-1); # Faction: Seru
    quest::faction(1486,-1); # Faction: Heart of Seru
