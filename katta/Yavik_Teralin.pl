sub EVENT_SAY { 
	if($text=~/Hail/i){
		quest::say("Greetings friend! Pull up a stool and order some of the finest ale in all of Luclin. If it's a [" . quest::saylink("What tale or two?",0,"tale or two") . "] you're lookin to hear as well I would suggest staying away from those two fools Arbogast and Miller. They're full of more hot air than a red dragon!");
	}
	if($text=~/tale or two/i){
		quest::say("I could tell you some interesting stories. I spent many years serving as a scout in the Validus Custodus. I've seen places and things that'll cause you to loose sleep for many days. One of the most facinating things I've seen however was while I was out on patrol near the [" . quest::saylink("What about Acrylia Caverns?",0,"Acrylia Caverns") . "].");
	}
	if($text=~/acrylia caverns/i){
		quest::say("The Acrylia Caverns are teeming with grimlings that tend to be a bit more evolved than your run of the mill dirtballs you find living in villages elsewhere on luclin. I was with a small patrol of scouts watching for any indication of the Acrylia Caverns Grimlings sending aid to the grimlings in Tenebrous Mountains during one of the Validus Custodus campains to rid the tenebrous mines of the little buggers. What we [" . quest::saylink("What was discovered?",0,"discovered") . "] was something quite different.");
	}
	if($text=~/discovered/i){
		quest::say("We spotted a small group of grimlings leaving the caverns hauling a cart full of acrylia ore. The strange thing was. this acrylia was darker than normal and instead of the normal golden hued veins it was covered with veins blacker than any darkness I've ever seen. I shadowed these grimlings to a grimling village some distance from the caverns where they exchanged some of this [" . quest::saylink("What is black acrylia?",0,"black acrylia") . "] with others of their kind.");
	}
	if($text=~/black acrylia/i){
		quest::say("Seems the grimlings use this rare acrylia ore to craft fierce weapons that not only cut or bash but strangle the spirits of those they harm. I observed some of their [" . quest::saylink("What method for crafting?",0,"method for crafting") . "] the black acrylia but not being knowledgeable of the smithing arts myself and the distance at which I had to observe made the details a bit obscure.");
	}
	if($text=~/method for crafting/i){
		quest::say("I explained my observations to one of our master smiths here in Katta Castellum and he has since successfully worked the ore. The difficulty of obtaining the [" . quest::saylink("What necessary supplies?",0,"necessary supplies") . "] for crafting the black acrylia however prevents the Validus Custodus and Magus Conlegium from doing extensive research of the strange ore.");
	}
	if($text=~/necessary supplies/i){
		quest::say("We have discovered that the grimlings use a special Black Acrylia Temper when crafting sheets of black acrylia and then again when crafting those sheets into weapons with the appropriate weapon molds. I saw this substance during my observations and after many attempts we seem to have discovered its [" . quest::saylink("What ingredients?",0,"ingredients") . "].");
	}
