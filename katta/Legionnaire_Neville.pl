...
sub EVENT_SAY  {
  if($text=~/Hail/i){
    ...
    quest::say("Ugh, I have not had such a cold as this since I was a boy. I have heard of a [" . quest::saylink("What teak maker?",0,"tea maker") . "] in the city of the Vah Shir that makes a stamina enhancing tea. I would like to try some and see if it might help.");
  }
  if($text=~/tea maker/i){
