...
sub EVENT_ITEM {
  ...
  if(plugin::check_handin(\%itemcount, 2691 => 4)){
    #End of Vamprye Fang
    quest::say("You have dedicated yourself to the war with the Coterie of the Eternal Night. I will continue to reward you for the fangs of every four vampyres that you slay. Should you be ambitious and skilled enough to confront the coterie leaders and live I will respectfully grant you the honor that you deserve.");
