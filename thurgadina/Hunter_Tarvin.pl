sub EVENT_SAY {
  if($text=~/hail/i) {
    quest::say("Good day, stranger. I would love to sit and chat with you but I don't much like gabbing it up with total strangers. I have other [" . quest::saylink("What other things?",0,"other things") . "] to think on, Good day.");
  }
  if($text=~/thing/i) {
