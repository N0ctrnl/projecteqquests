sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Ahem....yes, hail. I suppose that would suffice in this case. Well, then, hail to you, sir. I am Lorekeeper Gundlt, master keeper of etiquette. It is my duty, as ordained by the Grand Historian, to keep all records and rules on all [" . quest::saylink("What royal?",0,"royal") . "] audiences and dealings.");
  }
  if ($text=~/royal/i) {
    quest::say("Why, Frostreaver IV, of course! All who wish an audience must first consult with me to be educated on the proper way to address our great Dain. Do you wish an audience with the [" . quest::saylink("I wish an audience with the crown",0,"crown") . "]?");
  }
  if ($text=~/crown/i) {
