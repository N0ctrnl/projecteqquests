function event_say(e)
	...
	elseif(e.message:findi("Vagnar") and e.other:GetFaction(e.self) < 6) then
		e.self:Say("Vagnar? I don't recall.....Unless Vagnar was that shaman supposedly on some quest to save our entire race from total destruction..someone always on one of those. He bought some charms to ward of [" .. eq.say_link("Dragon kin") .. "]. He's most likely in the belly of some beast now.");
