...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 51615 => 1)) {#Heart of the Tyrant 
    quest::say("You made fast work of him. I need to clean this dagger before returning it to Variok. With Terris and her henchman chasing me I couldn't collect the pieces that I needed. Could you collect [" . quest::saylink("What three items?",0,"three items") . "] for me?");
