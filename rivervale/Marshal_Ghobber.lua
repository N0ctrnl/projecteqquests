...
function event_say(e)
	...
	if(e.message:findi("hail")) then
		e.self:Say("Greetings!  Allow me to introduce myself.  I am Marshal Ghobber Truppack.  Marshal of the Great Wall Patrol.  Are you [" .. eq.say_link("I am new to the squad",false,"new to the squad") .. "]?");
	...
	elseif(e.message:findi("new to the squad") and fac > 2 and fac < 5) then
		e.self:Say("Great!!! We require more deputies in this squad. We are suffering great losses to the [" .. eq.say_link("What new threat?",false,"new threat") .. "]. Welcome to the Great Wall Patrol where our motto is, 'United we shall defend.' It will be some time before you can earn your squad ring - first you must prove your strength in battle. Report to the squad leader. He is Deputy Budo. You can find him at the Great Wall of Serilis in the Misty Thicket. Go to him at once and tell him you are reporting for duty.");
