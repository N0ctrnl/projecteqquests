...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Stand at attention!! You don't look fit enough to toe-wrestle my grandma!! You cannot be in my squad!! Are you [" .. eq.say_link("I am petitioning",false,"petitioning") .. "] or are you a [" .. eq.say_link("I am a visitor",false,"visitor") .. "]?");
	elseif(e.message:findi("visitor")) then
		e.self:Say("Well, why didn't you say so?! Forgive me for hollering. Allow me to introduce myself. I am Marshal Anrey Leadladle, commander of the [" .. eq.say_link("Who are the Leatherfoot Raiders?",false,"Leatherfoot Raiders") .. "].");
	elseif(e.message:findi("petitioning")) then
		e.self:Say("So you want to be a [" .. eq.say_link("Who are the Leatherfoot Raiders?",false,"Leatherfoot Raiders") .. "]? What kind of joke is this? Look at you! You're a mess! Where are you [" .. eq.say_link("I am from Rivervale",false,"from") .. "]?");
