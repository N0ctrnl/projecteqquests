...
sub EVENT_DEATH_COMPLETE {
  ...
  quest::spawn2(162210,0,0,953,-324,403.1,380);
  quest::spawn2(162210,0,0,953,-316,403.1,380);
  quest::spawn2(162210,0,0,937,-332,403.1,380);
  quest::spawn2(162210,0,0,937,-324,403.1,380);
  quest::spawn2(162210,0,0,937,-316,403.1,380);
