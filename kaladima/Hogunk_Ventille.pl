...
sub EVENT_SAY { 
  if($text=~/Hail/i){
    quest::say("Hail. and welcome to Stormguard Hall. home to all great warriors! Are you also a [" . quest::saylink("I am a warrior of the Stormguard",0,"warrior of the Stormguard") . "] or do you [" . quest::saylink("I follow another guild",0,"follow another guild") . "]?");
  }
