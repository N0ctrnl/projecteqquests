...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("If you have nothing other than a hail to offer me you best move along, I need concentration to study these odd bones that I unearthed. Funny thing about them though, they seem to resonate a hum. Quite unusual, you probably aren't [" .. eq.say_link("interested") .. "] in that though.");
