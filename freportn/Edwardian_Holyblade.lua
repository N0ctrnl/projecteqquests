...
function event_say(e)
	...
	elseif(e.message:findi("recipe")) then
		e.self:Say("Once you have crafted your material from the specific recipes I give you, you will need the appropriate mold as I mentioned before. I can present you with the recipe and mold for Truthbringers [" .. eq.say_link("Helm") .. "], [" .. eq.say_link("Bracers") .. "], [" .. eq.say_link("Armguards") .. "], [" .. eq.say_link("Boots") .. "], [" .. eq.say_link("Greaves") .. "], [" .. eq.say_link("Gauntlets") .. "] and [" .. eq.say_link("Breastplate") .. "]. When you are ready to being collecting the components for a material recipe simply tell me what piece you want to craft.");
