...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say(string.format("Welcome %s! This is the Temple of Marr and you must be another seeker of passion and valor. That is good. Become one with us and help us to defeat the [" .. eq.say_link("fallen knight") .. "]. It is he who has caused the demise of this city.",e.other:GetName()));
	elseif(e.message:findi("knight")) then
		e.self:Say("The fallen knight I speak of is none other than Sir Lucan D'Lere. The self proclaimed ruler of this city. He is no ruler and he never was no true Knight of Truth. If it were not for the [" .. eq.say_link("Crusade of Tears") .. "] this city would still be united in valor.");
