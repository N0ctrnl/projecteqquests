function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say(string.format("It is good to see you. %s!! Do not forget that the clerics of Mithaniel Marr are here to help those who pay tribute to Him. Should you require me to [" .. eq.say_link("cure disease") .. "]. just mention it.",e.other:GetName()));
