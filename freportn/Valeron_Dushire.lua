...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("I am Sir Valeron Dushire, leader of the order of the Knights of Truth. If your soul shines with purity and strength, I urge you to join our order. The might of Mithaniel Marr stands behind all who join. Soon that might will help us free this city from the tyranny of the [" .. eq.say_link("Freeport Militia") .. "].");
	elseif(e.message:findi("freeport militia")) then
		e.self:Say("The Freeport Militia took control of this city long ago. They are nothing more than a group of thugs not worthy of respect. They follow the words of [" .. eq.say_link("Sir Lucan") .. "] D'Lere. He has been a thorn in this city's side for too long. If you wish to aid us in the fight against tyranny, go speak with Jemoz or Sir Theron. May the Truthbringer shine upon your soul.");
...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 6701})) then --a dusty old leg bone
		e.self:Say("According to this crest on the tunic, you have recovered one of the bones of a lost Paladin [" .. eq.say_link("Hero") .. "].");
