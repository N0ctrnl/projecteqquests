...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("May the Truthbringer guide your path. I am Celsar Vestagon, upholder of the faith and cleric of Mithaniel Marr. Did you come to see the [" .. eq.say_link("minnows of marr") .. "]?");
	elseif(e.message:findi("minnows of marr")) then
		e.self:Say("The Marr Minnow is unique to the Hall of Truth. It is a beautiful fish. Unfortunately, recently, reports of piranha have been heard. Due to greater concerns, I must look for assistance from noble clerics who wish to help Marr and [" .. eq.say_link("eradicate the piranha") .. "].");
