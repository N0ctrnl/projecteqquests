...
function event_say(e)
	...
	elseif(e.message:findi("fishing duties")) then
		e.self:Say("I have been creating shields for the crusade.  Right now I work on the sharkskin shield for the knights.  I require two shark skins. Unfortunately, most sharks are too dangerous for the squires.  I have begun using [" .. eq.say_link("reef shark") .. "] skins.  Will you hunt the [" .. eq.say_link("reef sharks") .. "]?");
