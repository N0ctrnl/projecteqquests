...
function event_say(e)
	...
	if(e.message:findi("hail")) then
		e.self:Say("Hail!  Welcome to the Hall of Truth.  We. the Knights of Truth. are all the hope this city has of loosening the grip of Lucan D'lere and his militia.  I seek a young knight to [" .. eq.say_link("I serve the will of the Truthbringer",false,"serve the will of the Trughbringer") .. "].");
	elseif(e.message:findi("serve the will of the truthbringer")) then
