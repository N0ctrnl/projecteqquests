...
function event_say(e)
	...
	if(e.message:findi("hail")) then
		e.self:Say("It is a good thing to see new faces visiting our temple. We are the source of strength within this city. Do not be fooled by the Freeport Militia. They are not warriors of valor. [" .. eq.say_link("Join the fight against the Freeport Militia") .. "].");
	elseif(e.message:findi("join the fight")) then
		e.self:Say("You are wise. If you are a paladin, either speak with Theron of this temple or visit the Hall of Truth here in North Freeport. Clerics should concetrate on keeping the knights strong and healthy. Would you care to [" .. eq.say_link("I will assist the Temple of Marr",false,"assist the Temple of Marr") .. "]?");
