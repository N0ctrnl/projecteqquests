...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("H..h..hello? Can you help me? I lost [" .. eq.say_link("Lost something?",false,"lost something") .. "] and I need it so I can go back home.");
	elseif(e.message:findi("something")) then
		e.self:Say("I never got my [" .. eq.say_link("What doll?",false,"doll") .. "] for my birthday. Before he could bring it to me I was h..hurt by the bad man. I cannot leave without my doll. Will you please help me?");
	elseif(e.message:findi("doll")) then
		e.self:Emote("claps her hands. 'Oh goody! But... I cannot seem to remember his name. He gave me this [" .. eq.say_link("What note?",false,"note") .. "] before I...");
