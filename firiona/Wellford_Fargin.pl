sub EVENT_SAY {
  if ($text=~/hobby/i) {
    quest::say("I used to collect rare coins and gems. I came to Firiona Vie to do just that, but I never have the time to [" . quest::saylink("collect rare coins") . "] when I am always here working.");
  }
