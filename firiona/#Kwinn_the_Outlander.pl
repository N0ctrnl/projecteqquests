...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Hail, adventurer! Kwinn's the name. Hunting is my game. I have been all over this continent. Seen many things and found [" . quest::saylink("odd trinkets") . "]. I have no quarrel with any race. I judge a person or critter by their actions. Heck, my best friend is a troll!!");
  }
  if ($text=~/odd trinkets/i) {
    quest::say("Blast!! I found some strange thingamajigs!! Most of it I toss or sell to vendors and crazy sages. I am on my way to sell this [" . quest::saylink("iron tail") . "] to a tinkerer.");
  }
  if ($text=~/iron tail/i) {
     quest::say("Found the thing washed up on the shore in Timorous Deep. Looks like a metal lizardman tail. It is all rusted and covered with barnacles. Probably can't get much for it, but I'll try. Why do you ask? Are you looking to [" . quest::saylink("trade for the mechanical thing") . "]?");
  }
