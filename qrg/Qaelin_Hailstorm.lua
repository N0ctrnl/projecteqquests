...
function event_say(e)
	...
	if(e.message:findi("hail")) then
		e.self:Say("Welcome to Surefall Glade. I have the great honor of bestowing these small but powerful Marks of Karana to those who follow him. With it they can use fletching to create bows and arrorws. If you [" .. eq.say_link("I need a mark",false,"need a mark") .. "] and are a true follower of Karana, I will give you all that you need. There is no fear running out.");
