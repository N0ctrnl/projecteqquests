...
sub EVENT_SAY {
  ...
  if($text=~/interested/i){
    ...
    quest::summonitem(55492); # Item: Stonewrath Chain Assembly Kit
  }
  if($text=~/boots/i){
    ...
    quest::summonitem(55488); # Item: Stonewrath Boot Mold
  }
  if($text=~/bracer/i){
    ...
    quest::summonitem(55486); # Item: Stonewrath Bracer Mold
  }
  if($text=~/coif/i){
    ...
    quest::summonitem(55485); # Item: Stonewrath Coif Mold
  }
  if($text=~/gloves/i){
    ...
    quest::summonitem(55490); # Item: Stonewrath Gloves Mold
  }
  if($text=~/gorget/i){
    ...
    quest::summonitem(55487); # Item: Stonewrath Gorget Mold
  }
  if($text=~/leggings/i){
    ...
    quest::summonitem(55489); # Item: Stonewrath Leggings Mold
  }
  if($text=~/tunic/i){
    ...
    quest::summonitem(55491); # Item: Stonewrath Tunic Mold
  }
  if($text=~/task/i){
...
sub EVENT_ITEM {
  ...
  if(plugin::check_handin(\%itemcount, 55470 => 4)){
    ...
    quest::summonitem(55493); # Item: Stonewrath Axe
  }
}
