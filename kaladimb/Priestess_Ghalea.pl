...
sub EVENT_SAY { 
   if ($text=~/hail/i) {
      quest::say("Welcome to the Church of Underfoot. Please open your soul to the greatness of Brell Serilis. May he guide you in all your future endeavors. And may your soles long for the [" . quest::saylink("What Soil of Underfoot?",0,"Soil of Underfoot") . "].");
      ...
      quest::say("The Candle of Bravery is used for temple ceremonies here in Kaladim. When the candle burns out, I must venture to the frigid village of Halas far to the north of the continent of Antonica. There I will take the candlestick and the [" . quest::saylink("What Soil of Underfoot?",0,"Soil of Underfoot") . "] to Dok. He must create the candle in the very ornate candlestick.");
   }
    elsif($text=~/trades/i) {
