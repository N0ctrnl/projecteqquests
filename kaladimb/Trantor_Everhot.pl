...
sub EVENT_SAY {
  if($text=~/hail/i) {
    quest::say("Yes, yes!! I am a very busy man. I've got blueprints to work on, [" . quest::saylink("What about your dwarven wire?",0,"dwarven wire") . "] to perfect and formulae to calculate. In between those tasks, I have to find time to head down to Irontoe's and down a few Tumpy Tonics.");
  }
  if($text=~/dwarven wire/i) {
    quest::say("Oh!! Interested in my dwarven wire, are you? Many are. I have no problem letting you use a spool, but I have to warn you that I have not perfected the strength of it yet. I will make you a trade. A couple of [" . quest::saylink("What are Tumpy Tonics?",0,"Tumpy Tonics") . "] for a spool.");
  }
