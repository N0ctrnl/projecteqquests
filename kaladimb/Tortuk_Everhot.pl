sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Welcome to the Everhot Forges! Home of the finest smiths in all of Kaladim! I teach experienced smiths how to work [" . quest::saylink("What is brellium ore?",0,"brellium ore") . "] and craft the finest dwarven battle shields and [" . quest::saylink("What dwarven plate?",0,"dwarven plate") . "].");
  }
