...
function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Greetin's! Justice speaks through us. We're the followers o' the Tribunal. We act as judge. jury and executioner fer all misled Northmen. Sometimes we must also execute our swift justice upon evil races. such as th' [" .. eq.say_link("What ice goblins?",false,"ice goblins") .. "].");
	elseif(e.message:findi("what ice goblins")) then
		e.self:Say("The ice goblins are a weak race. They pose no threat to our community. but lately we've heard rumors of ice goblins that can cast spells. They're said to be as weak as the goblin warriors. so I seek to employ the talents of our young shamans to [" .. eq.say_link("I will hunt the goblin casters",false,"hunt the goblin casters") .. "].");
