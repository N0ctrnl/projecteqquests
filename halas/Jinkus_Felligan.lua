...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Welcome! Welcome to the Church o' the Tribunal! Do ye require healing or are ye [" .. eq.say_link("I am new to the Shamans o' Justice",false,"new to the Shamans o Justice") .. "], then, eh?");
	elseif(e.message:findi("new to the shamans")) then
		e.self:Say("Then I welcome ye into our noble order. Ye'll serve us well or spend an eternity in the dungeons o' the Tribunal. Are ye willing to [" .. eq.say_link("I am willing to contribute",false,"contribute to our church") .. "] or did ye just come to meditate within our walls?");
	elseif(e.message:findi("contribute")) then
		e.self:Say("Well then, ye best be off ta find Holana Oleary, she organises our monthly Karan Clover shipments, just tell her Jinkus sent you to assist her. Or, I can have you [" .. eq.say_link("I will make a delivery",false,"make a delivery") .. "] for me."); --made up text
