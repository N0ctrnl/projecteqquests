...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hello. " .. e.other:GetName() .. "!  It's hard to believe just how cold it gets here!  It really has been wearing me down. Especially after the [" .. eq.say_link("What journey?",false,"journey") .. "] from Qeynos.");
	elseif(e.message:findi("what journey")) then
		e.self:Say("I have been traveling the face of Norrath to unravel the mystery of why my beloved [" .. eq.say_link("Who is your brother?",false,"brother") .. "] attacked a group of traveling bards.  He didn't survive the fight.  It's been so long. I can't really remember what he looked like!  I miss him so much...  Now all I have are his [" .. eq.say_link("What diary?",false,"diary") .. "] and some brewing recipes he sold before his death.");
	...
	elseif(e.message:findi("what diary")) then
		e.self:Say("The diary?  It's one of the two connections I still have to my brother.  Sadly. [" .. eq.say_link("What pages?",false,"pages") .. "] are missing from it.  I've been looking for them.");
