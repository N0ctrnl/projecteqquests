...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings to you brother. Did [" .. eq.say_link("Keven sent me",false,"Keven") .. "] send you?");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 13768})) then	--White Wolf Skin
		e.self:Say("Very good! I am sure by now you are learning much about your local surroundings. It is now time for you to learn to [" .. eq.say_link("I want to live off the land",false,"live off the land") .. "].");
		e.other:Ding();
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 16486, item2 = 16486, item3 = 16486, item4 = 2125})) then 					--Silk Thread x 3, Large Tattered Skullcap
		e.self:Say("'I see your wisdom grows, as does your skill. Wear this cap I have made for you. I believe you are now skilled enough to begin to pursue justice and to fight against our enemies. Are you [" .. eq.say_link("I am willing to fight",false,"willing to fight") .. "]?");
		e.other:Ding();
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 13897, item2 = 13897, item3 = 13897, item4 = 13897})) then	--Goblin Ice necklacess x 4
		e.self:Say("'I see you have brought many of our enemies to justice. You have done an excellent job and should be proud. No doubt your efforts saved lives. It is now time for you to venture out and fight stronger foes. Are you [" .. eq.say_link("I am up for the challenge",false,"up for the challenge") .. "] ?");
		e.other:Ding();
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 13915, item2 = 7005, item3 = 8011})) then 									--Gnoll Fang, Giant Snake Fang, Hunting Bow
		e.self:Say("You truly have justice in your heart. The spirits know this too. No doubt you are now beginning to hear their faint whispers. Soon you shall hear them clearly and you shall no longer need my guidance. I have one more [" .. eq.say_link("What favor?",false,"favor") .. "] to ask of you if you are [" .. eq.say_link("I am willing",false,"willing") .. "].");
		e.other:Ding();
