...
function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Hail there, " .. e.other:GetName() .. "! If you are not a [" .. eq.say_link("I am a member of the White Rose",false,"member of the White Rose") .. "], then it be best that you stay on the lower level. This here floor is for honest ...ermm respectable rogues only.");
