...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Fine day to ye, " .. e.other:GetName() .. ".  Welcome to me shop.  If ye're searchin' fer a [" .. eq.say_link("What cigar?",false,"cigar") .. "], ye won't be findin' any, more's th' pity.");
	elseif(e.message:findi("cigar")) then
		e.self:Say("I was hoping to perfect me creation I was callin' the 'cigar.' but I'm afraid I just couldn't get it right.  To keep from settin' meself on fire, I switched me talents to makin' candles.  I could use help from a person such as yerself.  Ye could [" .. eq.say_link("I will collect the wax",false,"collect the wax") .. "] fer me - the candle-makin's.");
	...
	elseif(e.message:findi("sweaty shirt")) then
		e.self:Say("Now, why would ye be wantin' that smelly thing?!!  I no longer have it.  [" .. eq.say_link("Who is Tundra Jack?",false,"Tundra Jack") .. "] came into me shop and bought it from me.  He says he can wash it good and make a new collar for Iceberg out of it.");
