...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hail, young adventurer! I'm the chief overseer o' the Shamans o' Justice. We serve the will o' the Tribunal. Justice is our way. Within Halas, there are none who are above the scales o' justice. There are still some who have defied our laws. We wish to [" .. eq.say_link("I can apprehend the fugitives",false,"apprehend the fugitives") .. "].");
	elseif(e.message:findi("apprehend the fugitives")) then
		e.self:Say("Maybe so, however, there are some who may be too much fer ye to handle. I'll need to know if ye're a [" .. eq.say_link("I am a y oung shaman",false,"young shaman") .. "] or a [standin' member of the court].");
