...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Hm, I don't recognize you, but perhaps you are one that has come to help me exact [" . quest::saylink("I will exact revenge",0,"revenge") . "]?");
  }
  if ($text=~/revenge/i) {
    quest::say("Yes, yes! Revenge is what I yearn. I want blood, amphibious blood, in the name of my brother who was killed many moons ago a [" . quest::saylink("What slimy swamp dweller?",0,"slimy swamp dweller") . "]");
  }
  if ($text=~/slimy swamp dweller/i) {
    quest::say("You imbecile! Can you not tell by my words that he was killed by the webbed hands of a [" . quest::saylink("What froglok?",0,"froglok") . "]!");
  }
  if ($text=~/froglok/i) {
    quest::say("The froglok I want to see dead is Dar Strategist Guib, a cherished froglok in that old troll city. He was in an elite troop of frogloks patrolling the Deserts of Ro during the invasion of Grobb. My brother was part of a small unit of Teir'dal tasked with assessing the capabilities of the Guktans for our king and queen. This Guktan discovered my brother's unit and attacked them. Most fled, but my brother was left behind to die. I need to exact my revenge, and I need to [" . quest::saylink("I will assassinate the froglok",0,"assassinate") . "] this foul froglok.");
  }
