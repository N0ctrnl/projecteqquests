sub EVENT_SAY { 
  if($text=~/why were you selected/i){
    quest::say("You dare to ask one such as I the will of the Hateful Father?! However. you do seem to be quite lacking in the field of thought and intelligence. which would easily explain why you have not heard my name nor of my [" . quest::saylink("What legend?",0,"legend") . "].");
  }
