sub EVENT_SAY { 
  if($text=~/Hail/i){
    quest::say("Welcome to my shop, $name. I am Felok N'Tan, master smith of steel and [" . quest::saylink("What adamantite plate?",0,"adamantite plate") . "] armors. I am also the creator of the [" . quest::saylink("What dragon shields?",0,"dragon shields") . "] favored by members of the Indigo Brotherhood.");
  }
