...
sub EVENT_SAY {
  if($text=~/hail/i) {
    quest::say("I hope you have a good reason for disturbing my contemplations. Perhaps you [" . quest::saylink("I seek knowledge",0,"seek knowledge") . "] of those who meditate within this Temple of Fear?");
  }
  ...
  if($text=~/duties/i) {
    quest::say("The primary duty of this temple is to spread terror, fright, and dread as a symbol of your devotion to our lord Cazic Thule. We are currently researching a means of summoning avatars of Fright, Terror and Dread, the primary minions of the Faceless in his home plane. Will you [" . quest::saylink("I will assist you in summoning",0,"assist me in summoning") . "] the avatar of Fright?");
  }
  if($text=~/assist/i) {
    quest::say("In order to summon the avatar of Fright. I require some special components for the ritual. Fetch me the flesh of a zombie. the dust used in the process of mummification. [" . quest::saylink("What charred bone chips?",0,"charred bone chips") . "]. and a [" . quest::saylink("What vial of Tunar's Breath?",0,"vial of Tunare's Breath") . "].");
  }
  if($text=~/chips/i) {
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 18019 => 1)) { # Harbingers of Fear Guild Note
    ...
    quest::say("Well done, go now and continue your contemplations of fear. Keep up with your [" . quest::saylink("What duties?",0,"duties") . "] and you will soon be reaping the rewards granted by our Lord Cazic-Thule!!");
