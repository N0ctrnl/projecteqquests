...
sub EVENT_SAY {
  if($text=~/Hail/i){
    quest::say("You tread upon sacred ground, $race. None may go further unless they [" . quest::saylink("I have business with the Overlord",0,"have business with the Overlord") . "], or, if you're looking to gain favor with the heretics and need a little coin, I have a [" . quest::saylink("What job?",0,"job") . "] for you.");
  }
  if($text=~/business/i){
