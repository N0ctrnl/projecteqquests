sub EVENT_SAY { 
  if($text=~/Hail/i){
    quest::say("Greetings. $name.  You have found the only place to purchase liquor in this fine city.  It seems that many of my countrymen do not appreciate liquor as I do.  Fear not if you spill. I have plenty of [" . quest::saylink("What skeletal servants?",0,"skeletal servants") . "] to clean up the mess.");
  }
