sub EVENT_SAY { 
  if($text=~/Hail/i){
    quest::say("Oh. hello there. $name!  I have been absolutely slaving all day to choose a new [" . quest::saylink("What advertisement",0,"advertisement") . "] for my wonderful store here.  Care to hear what I have?");
  }
