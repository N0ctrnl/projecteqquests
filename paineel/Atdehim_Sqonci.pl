...
sub EVENT_SAY {
  if($text=~/hail/i) {
    quest::say("Ah, greetings. I hope you are a student of the way of fear. Within this temple there are many who can teach you to harness your gifts. I am an instructor in the [" . quest::saylink("What rituals of ear?",0,"rituals of fear") . "].");
  }
