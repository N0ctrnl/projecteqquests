function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Emote("whispers, 'Speak softly outlander or you may end up like [" .. eq.say_link("Who is Frekka?",false,"Frekka") .. "] and some of the others.'");
	elseif(e.message:findi("frekka")) then
		e.self:Emote("whispers, 'He... [" .. eq.say_link("Experimented on her how?",false,"experimented") .. "] on her because she spoke so loudly in the cell. I fear I will be next. You should [" .. eq.say_link("You should leave",false,"leave") .. "] this place at once and never return...' ");
