...
sub EVENT_SAY { 
  if($text=~/Hail/i) {
    quest::emote("bows before you and says, 'Greetings to you as well, $name. I have recently heard many tales of your people and their glory. I am honored to welcome you to the Hall of Ancestors. Here our people come to pay tribute to the bravest and wisest of our kin who have passed from this life into Brell's holy domain. If you are interested I'd be happy to tell you a little bit about the [" . quest::saylink("What heroes?",0,"heroes") . "] buried here.");
  }
  if($text=~/what heroes?/i) {
    quest::emote("smiles at you, obviously pleased by your interest.");
    quest::say("This hall contains the bodies of Dain Frostreavers the I, II, and III as well as his grace Grand Historian Nicmar. There is also an empty bier in the back awaiting the next hero of our people. But the most [" . quest::saylink("What sacred tomb?",0,"scared tomb") . "] of all lies right behind me here.");
  }
...
sub EVENT_ITEM {
  ...
  if(plugin::check_handin(\%itemcount, 8896 => 1)) {
    quest::say("So, the Dain needs your assistance with the Field Plate. The Dain must trust you a great deal to impart the wisdom of our armor creation to you. Here are the tomes. The first details how to make the basic armor, the other details how to begin [" . quest::saylink("How do I begin working with gemstones?",0,"working with gemstones") . "]. If the Dain is asking you for them you should place them in an [" . quest::saylink("What Issue Kit?",0,"Issue Kit") . "]. May Brell guide your hand friend, good luck to you.");
