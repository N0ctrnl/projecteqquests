...
sub EVENT_SAY {
  ...
  #Hsagra's Wrath
    ...
    quest::say("In order to receive the teachings, you need to gather four runes from the [" . quest::saylink("Who are the descendants of Relinar?",0,"descendants of Relinar") . "]. Each descendant of Relinar has one of the four runes. You will find them where they stand six abreast in the wasteland. However in order to know that you have my blessing you must present them with a [" . quest::saylink("What treasure?",0,"treasure") . "] that they would know came from me.");
  #Hsagra's Wrath
