...
The horn must be from a dragon of no prominent social status that died from natural causes. The old dragon horn must also be treated with a [" . quest::saylink("What special shellac?",0,"special shellac") . "] before it is returned to me. I will also require a black sapphire that will be cut into a mouthpiece for the horn. If you bring me those items I will craft the horn for you and have it inscribed with the dragon script runes.");
  }
  if ($text=~/draconic drum/i) {
    quest::say("The frame of the drum must be crafted from Kromrif Bones and the skin of the drum must be crafted from a [" . quest::saylink("What Cured Brontotherium Hide?",0,"Cured Brontotherium Hide") . "]. If you bring me those items I will craft the drum for you and have it inscribed with the dragon script runes.");
  }
  if ($text=~/draconic lute/i) {
    quest::say("The strings of the draconic lute must be crafted from Siren Hair and the body of the lute must be carved from a Brontotherium Femur treated with a [" . quest::saylink("What special shellac?",0,"special shellac") . "]. If you bring me those items I will craft the lute for you and have it inscribed with the dragon script runes.");
  }
  if ($text=~/cured brontotherium hide/i) {
    quest::say("First you must hunt down a brontotherium and skin its hide. Once you have the hide it needs to be cured with a [" . quest::saylink("What special tannin?",0,"special tannin") . "] in a tailoring kit.");
  }
  if ($text=~/special tannin/i) {
    quest::say("The tannin used to cure the brontotherium hide must be created by a brewer from a Flask of Water, an [" . quest::saylink("What Oily Goo Secretion?",0,"Oily Goo Secretion") . "], and one [" . quest::saylink("What Melted Glacier Whiskey?",0,"Melted Glacier Whiskey") . "].");
  }
  ...
  if ($text=~/special shellac/i) {
    quest::say("The shellac used for the instruments must be created by a brewer from a Flask of Water, an [" . quest::saylink("What Oily Goo Secretion?",0,"Oily Goo Secretion") . "], and one [" . quest::saylink("What Kromrif Spit Vodka?",0,"Kromrif Spit Vodka") . "].
