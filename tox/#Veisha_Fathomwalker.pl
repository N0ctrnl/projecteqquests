...
sub EVENT_SAY {
  ...
  if($text=~/Phaeril/i) {
    quest::say("Phaeril Nightshire is the man with whom I have found comfort during these years of hardship. He has also taken the [" . quest::saylink("What position?",0,"position") . "] that belonged to Davorre many years ago.");
  }
  if($text=~/position/i) {
...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 12998 => 1)) { #Rolled up Note
    quest::say("Davorre, he is still alive! All these years I had thought him dead. He has kept his promise to me, and yet my most recent actions betray him so. I did not know. Here. Please give this to him with my most sincere regrets. I have moved on with my life and it is good to know that he is alive and well. But [" . quest::saylink("Who is Phaeril?",0,"Phaeril") . "] is now my life.");
