...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Hello, you look like a battleworn traveller. Have you heard of the place where [" . quest::saylink("Who is Grieg?",0,"Grieg") . "] resides?");
  }
  if ($text=~/grieg/i) {
    quest::say("Aye, Grieg Veneficus. We do not know much about this madman, only where his [" . quest::saylink("What stronghold?",0,"stronghold") . "] is. One of my friends from the Eye was sent there to investigate it, but he has not returned. It has been quite some time and I am very worried about him.");
  }
  if ($text=~/stronghold/i) {
    quest::say("Grieg's End is what it has become to be known as. Some reports have come back that this place is cursed with foul visages. Any entering will surely loose their minds. I.. I would go but you see I am desperately busy here in the city doing..uh..many important things! You look like you could help, will you [" . quest::saylink("I will travel to Grieg's End",0,"travel") . "] to Grieg's End and look for my friend?");
  }
  if ($text=~/travel/i) {
