...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("I suppose you're one of Nestrals new employees, eh? Well if that's the case I can help get you outfitted with some [" .. eq.say_link("gear") .. "] necessary for people in this [" .. eq.say_link("line of work") .. "].");
	elseif(e.message:findi("gear")) then
		e.self:Say("The first thing you need is a suit of sturdy traders clothing. Take this note to Verona Rankin and she'll help you with a suit tailored to your needs. Once you have been outfitted in your traders clothing return to me and I will inform you of your [" .. eq.say_link("next task") .. "].");
