...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Oh, hello.' Jasmine lowers her head. 'Sorry, I am not really in best form today. I am in a bit of a [" .. eq.say_link("big predicament") .. "].");
	elseif(e.message:findi("big predicament")) then
		e.self:Say("'I work for the League of Antonican Bards. As you may or may not know, we are sometimes tasked with the delivery of mail to various cities around Norrath. A shipment of mail was to be delivered from here to Qeynos. It was supposed to arrive several days ago but I have received word that it never arrived. I have recently been informed by the guards that the ship was stolen before it could leave port. The guards reported seeing a large number of trolls board the ship and sail away with it in the dead of the night. The League and myself would be most appreciative of such a brave adventurer's [" .. eq.say_link("help") .. "].");
