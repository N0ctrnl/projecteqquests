...
function event_say(e)
	...
	elseif(e.message:findi("help")) then
		e.self:Say("Yea and if you can help me out with A few things that'd be great. Geez and where do we Start? I need someone to run over to [" .. eq.say_link("Janan and Rebby's") .. "]? Can you do that for me?");
