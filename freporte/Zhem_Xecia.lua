...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("What is it maggot? I have only time for new clerics who have chosen to [" .. eq.say_link("I serve the Dismal Rage",false,"serve the Dismal Rage") .. "]. If you are looking for meaningless banter. than I suggest you find a bar wench.");
	elseif(e.message:findi("serve the dismal rage")) then
		e.self:Say("The clerics of the Dismal Rage must be strong and familiar with battle. There are many beings across Norrath who oppose our deity and our dogma. Take this note to Jerra Renlock and she will aid you in obtaining a suit of armor to protect you from the physical threats of our enemies and the creatures of the wild.  Once you have been properly outfitted return to me and will offer you [" .. eq.say_link("further instruction") .. "].");
