...
function event_say(e)
	...
	elseif(e.message:findi("what beast")) then
		e.self:Say("You're joking, right? You have never heard of the Blue Beast?!! She is the fastest ship in Norrath. She made the [" .. eq.say_link("Kunark run") .. "] in under three weeks. She was designed by [" .. eq.say_link("Bronto") .. "].");
