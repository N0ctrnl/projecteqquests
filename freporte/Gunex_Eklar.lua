...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Begone lest you seek instruction. I am very busy. I teach those who [" .. eq.say_link("I follow the path of rage",false,"follow the path of rage") .. "] as a Shadowknight. the leaders of the Dismal Rage.");
