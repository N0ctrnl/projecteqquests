...
sub EVENT_SAY {
  ...
  if($text =~ /are you heltin/i) {
    quest::say("Heltin? Heltin!?!? I knew a Heltin once! he was quite a good looking fellow if I remember correctly! Always very popular with the ladies at the Mermaid's Lure! I wonder what ever became of him. Oh yes, now I remember, he went Batty! Stark raving [" . quest::saylink("Why did you go mad?",0,"mad") . "]!' He begins to poke Katarin hard in the head presumably to accentuate his friend's madness. Although he rather seems to be enjoying himself as well.");
  }
