sub EVENT_SAY { 
if($text=~/Hail/i){
quest::say("A warm hello to you. $name! Please make yourself at home here in the serene locale of Sunset Home. Here you can forget about the [" . quest::saylink("queue") . "]. and enjoy the company of your fellow guides!");
}
