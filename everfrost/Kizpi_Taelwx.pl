...
sub EVENT_SAY {
  if(plugin::check_hasitem($client, 40900)) { #Satchel of Abu-Kar
    if($text=~/hail/i) {
      quest::say("Greetings! I see you have a fabulous Satchel of Abu-Kar in your possession. You are very lucky indeed to own such a wondrous item! I can however introduce to you a way to make it even better! Are you [" . quest::saylink("I am interested",0,"interested") . "]?");
    }
