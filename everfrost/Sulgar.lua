...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings. I am searching for the [" .. eq.say_link("wheel of Tarton") .. "]. If you will assist me I will provide you with [" .. eq.say_link("runes") .. "] to create a powerful spell.");
	...
	elseif(e.message:findi("wheel")) then
		e.self:Say("The wheel was broken into several pieces and scattered throughout the world. This book will give you clues as to their whereabouts. Once you gather all the pieces, they can be reassembled in a special [" .. eq.say_link("case") .. "]");
