...
function event_say(e)
	...
	elseif(e.message:findi("ivan's remains")) then
		e.self:Say("You were sent to retrieve the remains? I am sorry, I lost them. It was not my fault! There was no escort as I was told. I got lost returning to Halas and ended up on a frozen river. The ice broke and the remains were scattered into the freezing water. Will you [" .. eq.say_link("I will dive for the remains",false,"dive for the remains") .. "]?");
