...
function event_say(e)
	...
	elseif(e.message:findi("mira sayer's tax")and tax.tax_collection ~= nil) then
		e.self:Say("Ha! Yeah, I took their tax money. What are you going to do about it, little gnoll pup? Tell you want.. I will cut you a deal. You tell me you are a [" .. eq.say_link("I am a gnoll loving weakling who isn't fit to comb my feet?",false,"gnoll loving weakling who isn't fit to comb my feet") .. "] and I will give you that merchant's tax money.");
