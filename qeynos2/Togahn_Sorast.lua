...
function event_say(e)
	...
	if(e.message:findi("hail")) then
		e.self:Say("Greetings.. I am Second Master Togahn Sorast. I am here to teach the ways of our guild. For our more advanced members, I will give out [" .. eq.say_link("What headbands?",false,"headbands") .. "] as a reward for their contribution to the clan.");
	elseif(e.message:findi("headbands")) then
		e.self:Say("The Silent Fist Clan gives out colored Headbands for various deeds completed by our students. Phin gives out the White, Yellow, and Orange Headbands.. and I give out the [" .. eq.say_link("Red headband",false,"Red") .. "],[" .. eq.say_link("Purple headband",false,"Purple") .. "], and [" .. eq.say_link("Blue headband",false,"Blue") .. "] Headbands].");
	...
	elseif(fac <= 3) then
		...
		elseif(e.message:findi("purple headband")) then
			e.self:Say("Ah, you think you are now skilled enough to deserve the purple headband of the Silent Fist Clan? Very well, " .. e.other:GetName() .. ", I have a task for you that will prove whether or not you are worthy of this honor. I have heard recent rumors of ancient evils surfacing once again throughout Antonica. These evil groups have discovered some items that are giving them mystical and dangerous powers. These items must be destroyed, or else the evils of Norrath may gain control of the world's future. Bring me these [" .. eq.say_link("What evil items?",false,"evil items") .. "], and turn in your red headband, and you will have proven yourself a mighty spirit and dedicated member of the Silent Fist.");
		elseif(e.message:findi("evil items")) then
			e.self:Say("These evil creations have been found all over Antonica, and no one knows, or at least no one admits to knowing, where exactly they were found, but we do know that they are currently in the wrong hands and must be destroyed. Please, " .. e.other:GetName() .. ", seek out the [" .. eq.say_link("What is the Skull of Jhen'Tra?",false,"Skull of Jhen'Tra") .. "], the [" .. eq.say_link("What Dagger of Marnek?",false,"Dagger of Marnek") .. "], and the [" .. eq.say_link("What Coronet of Buried Blood?",false,"Coronet of Buried Blood") .. "], and bring them to me.");
		...
		elseif(e.message:findi("black headband")) then
			e.self:Say("The black headband is one of the highest honors of our guild.. [" .. eq.say_link("Who is Lu'Sun?",false,"Lu'Sun") .. "] only gives those out for great acts of heroism and devotion to the clan.");
		end
	else
