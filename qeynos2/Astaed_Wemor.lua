...
function event_say(e)
	...
	if(e.message:findi("hail")) then
		e.self:Say("Greetings. I am Astaed Wemor of the Paladins of the Temple of Life. We are the defenders of the all-giving Prime Healer.  Are you [" .. eq.say_link("I am here to pray",false,"here to pray") .. "] or are you [" .. eq.say_link("I am here to assist the temple",false,"here to assist the temple") .. "]?");
	...
	elseif(e.message:findi("assist the temple")) then
		e.self:Say("Good.  There are a few in the congregation who require assistance.  Will you be [" .. eq.say_link("I will be traveling afar",false,"traveling afar") .. "] or are you [" .. eq.say_link("I am staying close to Qeynos",false,"staying close to Qeynos") .. "]?");
