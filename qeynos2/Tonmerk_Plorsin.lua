...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hello. child.  Welcome to the Temple of Life. Here. you may pay homage to the [" .. eq.say_link("Who is the Prime Healer?",false,"Prime Healer") .. "]. [" .. eq.say_link("Who is Rodcet Nife?",false,"Rodcet Nife") .. "].  If you are in need of [" .. eq.say_link("I need healing",false,"need healing") .. "] or require me to [" .. eq.say_link("I need you to cure disease",false,"cure disease") .. "] or [" .. eq.say_link("I need you to cure poison",false,"cure poison") .. "], please inform me. I am the resident healer of all Qeynos citizens.");
	...
	elseif(e.message:findi("prime healer") or e.message:findi("rodcet nife")) then
		e.self:Say("He is the sustaining force of all life.  It is in honor of Him that the Temple of Life was built.  Engineered with the help of the [" .. eq.say_link("What is the Academy of Arcane Science?",false,"Academy of Arcane Science") .. "].");
	elseif(e.message:findi("academy of arcane science")) then
		e.self:Say("The Academy of Arcane Science is the greatest school of magic in Antonica.  It houses a wealth of resources and knowledge pertaining to any of the circles of magic.  It is also a marvel of magical engineering.  If you should ever visit Freeport. be sure to let me know.  I seek a faithful cleric to [" .. eq.say_link("I will pickup a reagent",false,"pickup a reagent") .. "].");
