...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings to you, citizen. By order of the Council of Qeynos I have been given the duty of apprehending the individuals [" .. eq.say_link("Who is responsible?",false,"responsible") .. "] for unleashing this terrible plague upon the people and the lands of Antonius Bayle. The more I look into this matter, the more I come to find that this will be no easy task.");
	elseif(e.message:findi("responsible")) then
		e.self:Say("The plague unleashed upon the Plains of Karana is the work of the followers of Bertoxxulous. Those responsible belong to group known as the Bloodsabers though there were others involved as well. Some time back, they launched a plot to overthrow Antonius Bayle and our ruling council. Their [" .. eq.say_link("What plan?",false,"plan") .. "] failed.");
	elseif(e.message:findi("plan")) then
		e.self:Say("Their plan was to unleash a plague so deadly and virulent that it would wipe out all life from here to Highpass Hold. They planned to brand themselves and their foul allies with a rune that would have rendered them immune to the effects of this plague. From that point they would have been able to simply walk in, easily defeat the weakened stragglers and declare themselves the rulers of this kingdom by default. But they were [" .. eq.say_link("How were they careless?",false,"careless") .. "].");
	elseif(e.message:findi("careless")) then
		e.self:Say("The sudden influx of scoundrels and loathsome individuals was our first tip off. They required a rather enormous number of supplies, materials and manpower to construct the ornate altars, craft and enchant their runed branding irons and supply their armies with the weapons needed for the cleanup work afterward. They needed to rely upon [" .. eq.say_link("What outside help?",false,"outside help") .. "].");
	elseif(e.message:findi("outside help")) then
		e.self:Say("They mostly chose to hire bandits and brigands who are foolishly more concerned with immediate profits than the long-term effects of their actions. But once they knew we were on to them they even started hiring some of the more 'civil' gnolls, if there is such a thing. Gnolls tend to be easy to push around, stupid, and they work very cheaply. They knew their time was short and they were desperate. Choosing to work with untrustworthy, lazy scoundrels caused the whole thing to begin to [" .. eq.say_link("How did it unravel?",false,"unravel") .. "], praise Rodcet!");
	elseif(e.message:findi("unravel")) then
		e.self:Say("Their workers were careless. Aside from noticing the unsavory element in our city, our citizens began to run across many of the strange items and materials that were being trafficked into our city en masse. It was at that point that the citizens began to [" .. eq.say_link("Why did they complain?",false,"complain") .. "] quite loudly about all of this.");
	elseif(e.message:findi("complain")) then
		e.self:Say("Obviously, they questioned the meaning behind these events and rightfully so. They were frightened much as they are now. I admit, I was remiss in my duties for not noticing it sooner. One of the biggest complainers during this time was a man by the name of [" .. eq.say_link("Who is Earron Huntlan?",false,"Earron Huntlan") .. "], proprieter of the famed Lion's Mane tavern. Though he is just a simple merchant, he did us a great service.");
	elseif(e.message:findi("Earron Huntlan")) then
		e.self:Say("Earron is quite a character. He gets all kinds of travelers stopping by his inn for a drink or whatever other business. His patrons started telling stories of being mugged and harassed by these loathsome individuals in the very streets of our fair city. Of course, he was concerned. So he became a kind of advocate for this cause, ringing the [" .. eq.say_link("What alarm?",false,"alarm") .. "] bell as it were. I admit, at first I did not believe the conspiracy. I simply could not believe it was all happening under our nose.");
	elseif(e.message:findi("alarm")) then
		e.self:Say("Well, he succeeded in whipping the populace into a frenzy. He even got the famous wizard Al'Kabor to help him out by determining the nature of the strange items many of our citizens were finding. Getting that man to do anything not directly related to his research is not an easy thing to accomplish either. Needless to say, at that point I saw the truth and the Prime Healer forgive me for not seeing it sooner. Were it not for the investigations and general outcry of [" .. eq.say_link("What concerned citizens?",false,"concerned citizens") .. "], we might not be standing here talking today.");
	elseif(e.message:findi("concerned citizens")) then
		e.self:Say("Yes, it was citizens like you that helped to save Qeynos that day. We uncovered their plot, captured the man who was in charge and put him to death. Of course, the Bloodsabers retaliated and using their incomplete research still managed to unleash the plague we face now. Though devastating in its own right, you must admit it is rather mild compared to what it might have been. I thank you for your interest. Perhaps you would be willing to [" .. eq.say_link("I will help",false,"help") .. "] me?");
	elseif(e.message:findi("help")) then
		e.self:Say("Excellent! The more I learn from my investigators the more I find that these Bloodsabers have stretched their tendrils of influence all throughout our beloved city. Nevertheless, we are committed to exposing these fiends once and for all. Perhaps you would like to become an [" .. eq.say_link("I would like to become an investigator",false,"investigator") .. "]?");
	elseif(e.message:findi("individual that unleashed this plague")) then
		e.self:Say("A woman named Azibelle Spavin unleashed the plague. She was the bodyguard and some say concubine of Mordavin Telase. He was put to death for his long list of crimes against Qeynos, which included murder, treason and attempted genocide.  The plague was apparently her revenge. I sent one of my investigators and one of the best guardsmen we have to try and find her and bring her to justice. They are [" .. eq.say_link("Where are they still missing?",false,"still missing") .. "].");
	...
	elseif(e.message:findi("investigator")) then
		e.self:Say(string.format("Very well then, %s. We will not allow just anyone to wear the official Investigator's Badge and please forgive me. . . But it is hard to tell where one's loyalties lie these days. If you are truly [" .. eq.say_link("I am serious",false,"serios") .. "] then there is a duty you must perform first to show you are on the side of Antonius Bayle, the council and the good people Qeynos.",e.other:GetName()));
	...
	elseif(e.message:findi("advance further") and e.other:HasItem(2386) == true) then
		e.self:Say("Interested in advancing further are you? Excellent, we are ready to begin the next phase of our operation. We have gathered a great deal of information as a result of the latest series of arrests. We do require [" .. eq.say_link("What interrogators?",false,"interrogators") .. "] that are able to pry the information we require out those less than willing to talk. Also, Velarte Selire at the Temple of Life is looking for help with his [" .. eq.say_link("What research?",false,"research") .. "]. You may wish to talk with him.");
	elseif(e.message:findi("advance further") and e.other:HasItem(2583) == true) then
		e.self:Say("Interested in helping us further? We continue to gather valuable information. We still require [" .. eq.say_link("What interrogators?",false,"interrogators") .. "] that are able to pry the information we require out those less then willing to talk. Also, Velarte Selire at the Temple of Life is looking for help with his [" .. eq.say_link("What research?",false,"research") .. "] so you may wish to talk with him. Lastly, we now have information we believe may lead us to the [" .. eq.say_link("I will find the individual that unleashed this plague",false,"individual that unleashed this plague") .. "] in the first place.");
