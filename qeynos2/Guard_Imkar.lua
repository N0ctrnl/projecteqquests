...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say(string.format("Hello, %s.  My name is Imkar and I am kind of new at this job but I can give you some advice.  Be careful here in Qeynos.  There are many [" .. eq.say_link("What dark forces?",false,"dark forces") .. "][dark forces] at work here that are best left undisturbed.",e.other:GetName()));
