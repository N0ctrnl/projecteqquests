...
function event_say(e)
	...
	if(e.message:findi("hail")) then
		e.self:Say("Welcome to the holy Temple of Life. Your presence shows an interest in our ways. We are the followers of the [" .. eq.say_link("Who is the Prime Healer?",false,"Prime Healer") .. "] and would gladly open our arms to any who [" .. eq.say_link("I serve Rodcet Nife",false,"Rodcet Nife") .. "]. Do we not all owe our lives to the sustaining force of the Prime Healer?");
	...
	elseif(e.message:findi("prime healer") or e.message:findi("rodcet nife")) then
		e.self:Say("The Prime Healer is Rodcet Nife. The one whose power flows through your body. He is the air that you breathe. To serve Him is to serve every living creature. Do you wish to [" .. eq.say_link("I serve the Prime Healer",false,"serve the Prime Healer") .. "] or do you [" .. eq.say_link("I need more time for contemplation",false,"need more time for contemplation") .. "]?");
