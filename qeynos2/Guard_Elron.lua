...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings. I am sorry but I can't concentrate on my post and talk to you at the same time. Especially when I should be out searching for [" .. eq.say_link("Who is Lucie?",false,"Lucie") .. "]..  Please excuse me.");
