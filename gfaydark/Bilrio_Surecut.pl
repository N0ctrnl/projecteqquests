...
sub EVENT_SAY {
  if ($text=~/hail/i) {#Need correct text
    quest::say("Well met $name, if you have some time on your hands I have a [" . quest::saylink("What proposition?",0,"proposition") . "] for you");
  }
  if ($text=~/proposition/i) {
    quest::say("Well, you see I am a smith, and I can make almost anything that you could want, however I have heard of a weapon of special power that I would like to try my skills on, however I lack some of the [" . quest::saylink("What meterials?",0,"materials") . "].  If you gather them for me I can forge the weapon and will give it to you for your assistance.");
  }
  if ($text=~/materials/i) {
