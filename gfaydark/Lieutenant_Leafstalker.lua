function event_say(e)
	...
	elseif(e.message:findi("quiver of kithicor")) then
		e.self:Say("Ummm.. I have some bad news. I did find it, but a band of brownie outcasts came in the night, took [" .. eq.say_link("all of the arrows") .. "] from the quiver and ran back to the forest they came from. As if that were not enough, while I was hot on their little heels, the thief [" .. eq.say_link("Wiltin Windwalker") .. "] came into Kelethin and took the quiver itself. Whew!! What a day!");
