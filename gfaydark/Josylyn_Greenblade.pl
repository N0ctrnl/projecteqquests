...
sub EVENT_SAY { 
if($text=~/Hail/i){
quest::say("Greetings $name. It is my duty to teach young Fier`Dal the arts of defense and fighting so that they may become skilled members of the Emerald Warriors. There are many [" . quest::saylink("What threats?",0,"theats") . "] facing our forests and our home Kelethin, thus we warriors must be prepared both physically and mentally to defend our people. It is wise for all young Emerald Warriors to acquire a [" . quest::saylink("What suit of armor?",0,"suit of armor") . "] to protect them from the weapons of our enemies.");
}
if($text=~/what suit of armor/i){
quest::say("You will require this specially prepared Mail Assembly Kit to assemble a suit of Emerald Novice Armor. The required materials vary depending on the piece of armor you seek to craft. Once you have been properly outfitted return to me and I will present you with another [" . quest::saylink("What task?",0,"task") . "]. Do you seek to craft [" . quest::saylink("Emerald Novice Gauntlets") . "], [" . quest::saylink("Emerald Novice Boots") . "], an [" . quest::saylink("Emerald Novice Bracer") . "], an [" . quest::saylink("Emerald Novice Helm") . "], [" . quest::saylink("Emerald Novice Greaves") . "], [" . quest::saylink("Emerald Novice Vambraces") . "], or an [" . quest::saylink("Emerald Novice Breastplate") . "]?");
