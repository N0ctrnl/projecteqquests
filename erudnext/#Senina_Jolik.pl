...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Hello, stranger, welcome to Erudin. I would invite you to browse my store, but alas my latest supply shipment has not come in. I am very worried. Perhaps if you have the time, you could [" . quest::saylink("I will assist you",0,"assist") . "] me with this predicament?");
  }
