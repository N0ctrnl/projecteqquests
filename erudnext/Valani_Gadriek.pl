...
sub EVENT_SAY {
  ...
  if($text=~/hail/i) {
    quest::say("Hello, $name. Feel free to browse my wares. Unless you are looking to make a special Erudian robe. If so, just let me know that you want a [" . quest::saylink("robe pattern") . "]."); #Still need real text
  }
