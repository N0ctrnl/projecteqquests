...
function event_say(e)
	...
	elseif(e.message:findi("business")) then
		e.self:Say("Flynn had talked Moodoro into delivering the waters to him in Qeynos. Eventually Moodoro was caught. He was sentenced to death, but a few spells from yours truly helped him escape death by replacing him with a [" .. eq.say_link("doppleganger") .. "].");
