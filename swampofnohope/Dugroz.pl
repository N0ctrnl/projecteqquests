...
sub EVENT_SAY {
  if($text=~/hail/i){
    quest::say("Fffrroaaak!!  Go away!  I don't want to [" . quest::saylink("I will work for them",0,"work for them") . "] anymore! Go find another slave!");
  }
  if ($text=~/work/i) {
    quest::emote("looks relieved and eyes you, considering. Finally, he begins to recant his tale. 'I was once the slave of an important Iksar necromancer. I was his Dugroz, his head slave. One night, I heard two other slaves talking about me. I could barely hear them but what I did hear frightened me. My master was going to use me one last time. He was going to sacrifice me to craft a spell component for one of his most powerful spells. Hearing this, I used my privileges as his head slave and made my [" . quest::saylink("What escape?",0,"escape") . "].'");
  }
  if ($text=~/escape/i) {
    quest::say("After I escaped, I lost myself in the depths of the swamp. I discarded all the keys but one. I will gladly give it to you if you can do me a [" . quest::saylink("What small favor?",0,"small favor") . "].");
  }
