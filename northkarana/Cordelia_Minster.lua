...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings!  I am Cordelia, a traveling piper. I am afraid I cannot play a tune for you, however, as my [" .. eq.say_link("What flute?",false,"flute") .. "] is gone.");
