...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hey. hey! I have some Blackburrow Stout for sale. Just hand over five gold and I'll give you a bottle of it. Don't get caught though because it is considered [" .. eq.say_link("Why is it contraband?",false,"contraband") .. "]. [" .. eq.say_link("Who is Antonius?",false,"Antonius") .. "] don't like it being smuggled and all that but what does he know. anyway?");
