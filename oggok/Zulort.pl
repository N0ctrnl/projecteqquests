...
sub EVENT_SAY {
  if($text=~/hail/i) {
    quest::say("Um, you. Hi.. You Shaman of War now, right? You gotta learns war and war spells. We fights all and makes the Warlord likes us. You [" . quest::saylink("I am gonna help",0,"gonna help") . "] or me gonna feed you fat stoopid boddie to doggies.");
  }
  if($text=~/help/i) {
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 13187 => 4)) {
    quest::say("Oh, me.. um.. Warlord BERRY happy. Berry like dese. Gimme. Uh, why is you still here? Take dis and gets more kills. You learning good, come sees me. I teaches you bout stuff. Make you [" . quest::saylink("Make me a bedder shaman",0,"bedder shaman") . "]. Go. He and me watching.");
    ...
    quest::say("Take, take.. You now Shaman of War.. Zulort make you majik, too.  When you [" . quest::saylink("I am gonna help",0,"gonna help") . "] you tell Zulort. You return to me and when you stronger, I teach you many things I know, including how to start working in the various [" . quest::saylink("What trades?",0,"trades") . "].");
