sub EVENT_SAY { 
  if($text=~/Hail/i){
    quest::say("Me got da toughest weapons in da lands! Yoo come ta buy weapon or ta learn from Varrok bout [" . quest::saylink("What war mace?",0,"war mace") . "] an [" . quest::saylink("What war hammer?",0,"war hammer") . "]?");
  }
