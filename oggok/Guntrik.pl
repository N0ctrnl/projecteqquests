...
sub EVENT_SAY { 
  if($text=~/hail/i){
    quest::say("Mmmph!!  Who you?  Oh. you $name.  You supposed to be promising Craknek.  Me need you.  There bad things in swamp.  You want [" . quest::saylink("What help Crakneks",0,"help Crakneks") . "] or you [" . quest::saylink("I want Gruntrik to bash my face",0,"want Guntrik bash your face") . "]!!?");
  }
...
sub EVENT_ITEM { 
  if (plugin::check_handin(\%itemcount, 18787 => 1)) {
    quest::say("Ahh..  good..  good..  here. take..  Now you Craknek! You bash good. Bash lizards. Bash froggies. Bash mushrooms. Remember. you no help Greenbloods. Crakneks stronger than Greenbloods. When you [" . quest::saylink("I want to help Crakneks",0,"help crakneks") . "] you tell Guntrik. You return to me when you stronger, I teach you many things I know, including how to start working in the various [" . quest::saylink("What trades?",0,"trades") . "].");
