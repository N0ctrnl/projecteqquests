...
sub EVENT_SAY {
  if($text=~/Hail/i){
    quest::say("Need new members we do not. Powerful enough are we with Grevak. Still. peons needed. Are you a [" . quest::saylink("I am a new peon",0,"new peon") . "] or are you an [" . quest::saylink("I am an outsider",0,"outsider") . "]? Speak up!! Fool!! No time Grevak has!!");
  }
