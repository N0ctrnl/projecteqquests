...
sub EVENT_SAY {
  ...
  if($text=~/sleeves/i){
    ...
    quest::summonitem(51357); # Item: Armband Pattern of Scale
  }
  if($text=~/boots/i){
    ...
    quest::summonitem(51360); # Item: Boot Pattern of Scale
  }
  if($text=~/bracers/i){
  ...
  if($text=~/gloves/i){
    ...
    quest::summonitem(51359); # Item: Gauntlet Pattern of Scale
  }
  if($text=~/caps/i){
    ...
    quest::summonitem(51356); # Item: Helm Pattern of Scale
  }
  if($text=~/leggings/i){
    ...
    quest::summonitem(51361); # Item: Legging Pattern of Scale
  }
  if($text=~/strong/i){
...
sub EVENT_ITEM {
  ...
  if(plugin::check_handin(\%itemcount, 55212 => 4)){
    ...
    quest::summonitem(55213); # Item: Bakrishal's Scaled Claws
  }
}
