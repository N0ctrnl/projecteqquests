...
function event_say(e)
	if(e.other:Class()== "Paladin" and (e.other:Race() == "High Elf" or e.other:Race() == "Half Elf")) then
		...
		elseif(e.message:findi("suit of armor")) then
			e.self:Say("You require this special Mail Assembly Kit in order to fashion your Felwithe Defender's Armor. The materials necessary for the armor's construction vary according to the piece you are attempting to craft. Once you have been properly outfitted return to me and I will provide you with [" .. eq.say_link("further instruction") .. "]. Do you plan on crafting [" .. eq.say_link("Felwithe Defender Gauntlets") .. "], [" .. eq.say_link("Felwithe Defender Boots") .. "], an [" .. eq.say_link("Felwithe Defender Bracers") .. "]. an [" .. eq.say_link("Felwithe Defender Helm") .. "], [" .. eq.say_link("Felwithe Defender Greaves") .. "], [" .. eq.say_link("Felwithe Defender Vambraces") .. "], or a [" .. eq.say_link("Felwithe Defender Breastplate") .. "]?"); 
