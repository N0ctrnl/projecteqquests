function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Well met. " .. e.other:GetName() .. "! I am a master craftsman of both steel and [" .. eq.say_link("mithril plate") .. "] armors. I am also the creator of the [" .. eq.say_link("woodlanders shields") .. "]. Light shields perfect for those who spend much time under the canopy of the All Mothers forests.");
