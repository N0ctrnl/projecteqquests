...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Welcome friend! Have you come to the Temple of Tunare to give praise or are you a young Cleric seeking [" .. eq.say_link("guidance") .. "] from your elders?");
	...
	elseif(e.message:findi("guidance")) then
		e.self:Say("Tunare shall be pleased to have a new disciple amongst her Koada`Dal children. We Clerics of Tunare offer spiritual guidance to the citizens of Felwithe and when needed aid the Paladins of Tunare and the Keepers of the Art in the defense of our people and forest from those [" .. eq.say_link("creatures") .. "] that seek to cause us harm. Every young cleric should pursue acquiring a [" .. eq.say_link("suit of armor") .. "] to protect themselves when aiding those in need outside of the safety of Felwithes walls.");
	...
	elseif(e.message:findi("suit of armor")) then
		e.self:Say("You will need this Mail Assembly Kit to craft your Sylvan Initiate Armor. The materials required for the armor vary according to which piece you desire to craft. Once you have been suitably outfitted return to me and I will offer [" .. eq.say_link("further guidance") .. "]. Do you desire to craft [" .. eq.say_link("Sylvan Initiate Gauntlets") .. "], [" .. eq.say_link("Sylvan Initiate Boots") .. "], a [" .. eq.say_link("Sylvan Initiate Bracer") .. "], a [" .. eq.say_link("Sylvan Initiate Helm") .. "], [" .. eq.say_link("Sylvan Initiate Greaves") .. "], [" .. eq.say_link("Sylvan Initiate Vambraces") .. "], or a [" .. eq.say_link("Sylvan Initiate Breastplate") .. "]?");
