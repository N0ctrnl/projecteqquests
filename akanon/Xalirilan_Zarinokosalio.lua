...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Oi there! Its nice to meet you. You must excuse me for I am currently working on a special spell for my studies. I would love to talk but I have to teach a class very soon to the new [" .. eq.say_link("initiates") .. "] and I don't have my lesson prepared yet. Are you also a [" .. eq.say_link("young initiate of the Eldritch Collective") .. "]? If you are then I hope you will be ready for the lesson.");
	elseif(e.message:findi("initiate")) then
		e.self:Say("Excellent. You must understand that I am very pressed for time but if you are a young initiate of the Collective then I always have time to share my knowledge with you. If you are interested I have some [" .. eq.say_link("training") .. "] for you to begin. These tasks will help you prepare for the upcoming lesson as well!");
	elseif(e.message:findi("training")) then
		e.self:Say("I have a number of tasks that I ask new recruits of the Eldritch Collective to complete. These task will test both your ability to fight as well as your navigational skills, 2 very important factors on your road to infinite knowledge. When you are ready to begin your journeys I will present you with a Tinkered Sewing Kit that you will use to gather numerous [" .. eq.say_link("important components") .. "].");
	elseif(e.message:findi("important components")) then
		e.self:Say("All right then, here is your Tinkered Sewing Kit. In this sewing kit you will combine a number of recipes that will be used for creating your Eldritch Collective Initiate Armor. When you are ready to craft a certain armor piece all you must to is tell me which piece you [" .. eq.say_link("want") .. "] to craft. I will then present you with the component recipe along with the applicable pattern for [" .. eq.say_link("Caps") .. "], [" .. eq.say_link("Bracers") .. "], [" .. eq.say_link("Sleeves") .. "], [" .. eq.say_link("Sandals") .. "], [" .. eq.say_link("Trousers") .. "], [" .. eq.say_link("Gloves") .. "] and [" .. eq.say_link("Robes") .. "]. When you have completed the material for whatever piece you asked for you will combine it in a sewing kit with the appropriate pattern to fashion your armor piece. I do suggest though that you attempt your robe last as the components are more difficult then any other piece to collect.");
	...
	elseif(e.message:findi("final task")) then
		e.self:Say("Well I have been studying some new annals that were presented to me by some high councilmen in Rivervale. They had found them will excavating some ruins in the Gorge of King Xorbb and were unable to decipher what they meant. I had them bound in a special tome but unfortunately some pickpockets stole them from me in hopes that they would bring them great power I suppose. If you can find these 4 pages for me I would be very grateful for I would be able to finish my studies of them. Will you [" .. eq.say_link("seek out the stolen tome pages") .. "]?");
