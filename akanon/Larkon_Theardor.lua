...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings! Welcome to the Library of Mechanimagica. You must be a [" .. eq.say_link("I am a current member of teh library",false,"current member of the library") .. "] or has my [" .. eq.say_link("Your mind has begun to slip",false,"mind begun to slip") .. "]?");
