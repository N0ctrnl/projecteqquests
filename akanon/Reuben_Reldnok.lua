...
function event_say(e)
	...
	elseif(e.message:findi("armor recipe")) then
		e.self:Say("I have all the armor recipes and molds that you will need to get started all you must do is simply tell me what armor piece you [" .. eq.say_link("want to craft") .. "]. I can provide you with the recipes and molds for Deep Muses [" .. eq.say_link("Helms") .. "]. [" .. eq.say_link("Bracers") .. "]. [" .. eq.say_link("Armguards") .. "]. [" .. eq.say_link("Boots") .. "]. [" .. eq.say_link("Greaves") .. "]. [" .. eq.say_link("Gauntlets") .. "] and [" .. eq.say_link("Breastplates") .. "]. I must recommend that you attempt to gather the items for your breastplate last because the components required for it are the most difficult to collect.");
