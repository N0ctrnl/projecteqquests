...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("It is very nice to meet you " .. e.other:GetName() .. ". I am Iony Gredlong Priestess of the Underfoot. I coordinate all the training for new clerics here in the Deep Musing. If you are a [" .. eq.say_link("cleric") .. "] then I might just have some tests for you that will challenge your wisdom as well as your fighting abilities.");
	elseif(e.message:findi("cleric")) then
		e.self:Say("Well you would certainly be eligible for my training then young " .. e.other:GetName() .. ". I have a number of armor recipes that I give to young clerics to make sure that when they leave the comfort of the Steamfont Mountains they are ready for whatever battles they may face. If you are [" .. eq.say_link("I am interested in creating my own armor",false,"interested in creating your own armor") .. "] then all you must do is simply ask and I will give you instructions to get started.");
	elseif(e.message:findi("interested in creating")) then
		e.self:Say("I am always happy to see an eager young one like yourself! Brell certainly takes pride in all young gnomes that draw power from him to give life so you should consider yourself very special. To create your own armor you are going to collect [" .. eq.say_link("various items") .. "] from Ak`Anon and Steamfont. You will then combine them in this assembly kit. Once you have made a material you will place it in a forge along with molds that I will present to you to create your armor.");
		e.other:SummonItem(17253); -- Item: Holy Assembly Kit
	elseif(e.message:findi("various items")) then
		e.self:Say("There are numerous items that you will need to collect and combine in your kit. I will present you for the recipe for Shortnoble Platemail [" .. eq.say_link("Helms") .. "], [" .. eq.say_link("Bracers") .. "], [" .. eq.say_link("Armguards") .. "], [" .. eq.say_link("Boots") .. "], [" .. eq.say_link("Greaves") .. "], [" .. eq.say_link("Gauntlets") .. "] and [" .. eq.say_link("Breastplates") .. "]. When you are ready to attempt a specific piece please let me know what piece you want to [" .. eq.say_link("craft") .. "] and I will give you the necessary mold along with the recipe.");
	...
	elseif(e.message:findi("breastplate")) then
		e.self:Say("I believe you are ready to craft and gather the components for the most difficult piece of Shortnoble Platemail. To create your breastplate material you will need to combine 5 Bricks of Crude Bronze, 1 Clockwork Spider Thorax Plate, 1 Brownie Parts, 1 Aviak Talon 1 Scrap Metal and the evil Halorniop`s Insignia in your assembly kit. Once you have created the proper material take it to a forge along with this mold to fashion your very own Shortnoble Platemail Breastplate. Return to me for one [" .. eq.say_link("final favor") .. "] I have to ask of you after you have completed your breastplate.");
		e.other:SummonItem(22616); -- Item: Enchanted Breastplate Mold
	elseif(e.message:findi("final favor")) then
		e.self:Say("I thank you for returning to me young Gearsword. I must say that it is now quite clear that you are very capable of completing any task I should assign you due to your eagerness to learn. I am currently in need of a few specific items to craft a weapon worthy of any servant of Brell. It is my hope that I can pass these out to our new recruits quite soon. Will you [" .. eq.say_link("I will collect the items you require",false,"collect the items I require") .. "]?");
