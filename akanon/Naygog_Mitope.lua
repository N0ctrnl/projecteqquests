...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hail " .. e.other:GetName() .. ". I train those young gnomes who wish to [" .. eq.say_link("I wish to serve as a warrior",false,"serve as a warrior") .. "] in the service of the Dark Reflection and our patron. Bertoxxulous the Plaguelord. Decay and destruction are powerful forces that influence Norrath. It is the duty of the Warriors of the Dark Reflection to bring destruction to the weak and injury to the strong so that our fellow gnomes may be reminded of their own mortality and new strong individuals may rise to power before Bertoxxulous decides it is their time to decay and be replaced like countless before them.");
...
function event_trade(e)
	...
	elseif (item_lib.check_turn_in(e.trade, {item1 = 18759})) then -- Stained Parchment
		e.self:Say("This is fabulous news!! You have done well, young one. Once you are ready for [" .. eq.say_link("further instruction") .. "] please let me know, I will guide you through your early and most dangerous days. When you have become more experienced in our art, I will be able to further train you, both in our art as well as in some of the various [" .. eq.say_link("trades") .. "] you will have available to you.");
