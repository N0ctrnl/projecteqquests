...
function event_say(e)
	...
	elseif(e.message:findi("translating device") and e.other:HasItem(52947)) then
		e.self:Say("Rilgor Plegnog rubs his chin thoughtfully. 'A translating device? Now that is something rather complicated. It would take all of my skill as both a tinkerer and an enchanter. This is not the sort of thing I would do for nothing, no no no. I would need some sort of [" .. eq.say_link("compensation") .. "] for a project like that!' ");
