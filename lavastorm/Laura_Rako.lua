...
function event_trade(e)
    local item_lib = require("items");
        ...
        if (item_lib.check_turn_in(e.trade, {item1 = 56010})) then --Check for "Talisman of the Plasmatic Priests"
            ...
            eq.spawn2(27128, 0, 0, 113, 1672, 56, 462); -- needs_heading_validation
            -- Spawn 2 A Plasmatic Priest
            eq.spawn2(27129, 0, 0, 132, 1669, 55, 0);
            eq.spawn2(27129, 0, 0, 89, 1672, 55, 80);
            -- Spawn 3 A Plasmatic Priestess
            eq.spawn2(27130, 0, 0, 113, 1650, 56, 502); -- needs_heading_validation
            eq.spawn2(27130, 0, 0, 95, 1706, 54, 412);
            eq.spawn2(27130, 0, 0, 125, 1709, 55, 274); -- needs_heading_validation
            eq.depop_with_timer();
        end
