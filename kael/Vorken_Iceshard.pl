...
sub EVENT_SAY {
  if ($faction == 1) { #Require Ally faction
    ...
    if ($text=~/beleveios/i) {
      quest::say("Beleveios came seeking my brother and me to slay us and end the whining of the weaker giants. The day is still crisp in my mind. Four of his greatest champions fell upon my brother and me in our encampment, attempting to slay us in our sleep. We Iceshards are not so easy to slay, however. Klaggan awoke as they attempted to slit our throats and snapped the neck of one of our assailants. I leaped to my feet as well, and with my trusty axe I slashed at the knaves who had come to [" . quest::saylink("Why did he come to murder you?",0,"murder") . "] us.");
    }
    if ($text=~/murder/i) {
      quest::say("Yes, they tried to stop our actions without so much as a trial by honorable combat. My brother and I slaughtered Beleveios' most powerful guards as he watched. When the last one fell, I was covered in the blood of my foes, as was Klaggan. Beleveios stood there dumbfounded, before he dropped to his knees begging for our mercy and forgiveness. He prattled on about his [" . quest::saylink("What did he say about his family?",0,"family") . "], and wanting to protect his people. I would hear no more of this. His head lay on the ground not long after that.");
    }
    if ($text=~/family/i) {
