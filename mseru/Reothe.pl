...
sub EVENT_SAY{
  if ($text=~/Where is Bregun Dorey/i) {
    quest::say("Bregun Dorey... I have not heard that name in many years. I will never forget it. He was very unique, always running around with an odd metal hat on. He swore that it would keep out the mind probing magics of the Question. I know where he was last seen, and I will tell you if you help by getting us some [" . quest::saylink("What supplies?",0,"supplies") . "].");
  }
