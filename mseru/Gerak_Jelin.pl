...
sub EVENT_SAY {
  ...
  if($text=~/sister is worried/i) {
    quest::say("You talked to her? Surely she didn't come right out and say that though, that would get her removed from the Hand, and most definately the city. I am glad you were smart enough to read her emotions to see that she thought of me. It really makes my heart warm and gives me hope. It is difficult living here, we are under constant attack, and have no way to get food. I wish I had some [" . quest::saylink("What good news?",0,"news") . "] for her.");
  }
  if($text=~/good news/i) {
