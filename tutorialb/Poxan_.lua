...
function event_say(e)
	if (e.message:findi("hail") and eq.is_task_active(22)) then -- Basic Training(22)
		e.self:QuestSay(e.other," sighs heavily as he peers into the murky water. 'This is terrible, I've dropped my sword into the water and I can't swim! I don't suppose you could get it back for me, " .. e.other:GetName() .. "? I can't very well fight kobolds without a sword.'",{speak_mode = SpeakMode.Emote});
