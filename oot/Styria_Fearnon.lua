...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Welcome to my island. I always welcome visitors, but I would prefer that your stay not last too long. My warriors are sometimes tempted by others. That is why they all wear purity belts. I should warn you, also, to be on the lookout for the [" .. eq.say_link("Who are the Pirates of Gunthak?",false,"Pirates of Gunthak") .. "].");
	elseif(e.message:findi("pirates of gunthak")) then
		e.self:Say("The Pirates of Gunthak have been stranded on a nearby island. Their ship was sunk by some unknown water beast. They now attempt to take over this island and commandeer the first ship they encounter. I am looking for brave [" .. eq.say_link("What adventurers?",false,"adventurers") .. "] to hunt the rogues. Do you wish to hunt the pirates or are you waiting for the next ship?");
