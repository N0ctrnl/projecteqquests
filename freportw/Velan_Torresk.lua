...
function event_say(e)
	...
	elseif(e.message:findi("sash")) then
		e.self:Say("The Sashes of Order are given out by the various trainers of our clan. I give out the [" .. eq.say_link("white training sash") .. "] and the [" .. eq.say_link("yellow Sash of Order") .. "], and [" .. eq.say_link("Who is Reyia?",false,"Reyia") .. "] is in charge of the orange and red sashes.");
	end
end
