...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Pleasure to meet you "..e.other:GetName()..". I am Klom Jysun, Grandmaster of the Ashen Order. I have lived in the great city of Freeport for quite sometime now and have watched the city evolve and change. Nowadays though I am in charge of training new members of the Ashen Fist. If you are a young monk and are in need of some armor I might have some work for you. Are you a [" .. eq.say_link("I am a monk",false,"monk") .. "]?");
	elseif(e.other:Class() == "Monk") then
		if(e.message:findi("monk")) then
			e.self:Say("I am always pleased when a new disciple visits our sacred halls. If you are [" .. eq.say_link("I am interested",false,"interested") .. "] in crafting your own armor I have a number of gathering tasks for you to do that will test both your navigational and fighting skills.");
		elseif(e.message:findi("interested")) then
			e.self:Say("I am very pleased to here about your interest in proving your worth to the Ashen Order. First let me present you with this Fistfighters Sewing Kit. Inside of it you will combine [" .. eq.say_link("various components") .. "] to form armor materials. Once you have a material for a certain piece of armor you will combine it in a Loom along with the appropriate pattern. When you inform me what piece of armor you want to craft. I will be able to present you with the component recipe and pattern needed for crafting it.");
			e.other:SummonItem(17261); -- Fistfighters Sewing Kit ID-17261
		elseif(e.message:findi("various components")) then
			e.self:Say("The items you will need to collect are all over the Freeport area, some in stores some off vicious monsters. If you are up for the challenge though I will be able to provide you with the armor recipes and patterns for Stonehand [" .. eq.say_link("Cap") .. "], [" .. eq.say_link("Bracers") .. "], [" .. eq.say_link("Sleeves") .. "], [" .. eq.say_link("Sandals") .. "], [" .. eq.say_link("Trousers") .. "], [" .. eq.say_link("Gloves") .. "] and [" .. eq.say_link("Robes") .. "]. All you will need to do is tell me what piece of armor you want to craft, and I will be able to present you with the component recipe and pattern needed for crafting it.");
