...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Emote("grunts as she tries to fill two buckets of [" .. eq.say_link("water") .. "]. Her frail arms strain at her work and pain fills her eyes with tears.");
	elseif(e.other:Class() == "Paladin") then
		if(e.message:findi("water")) then
			e.self:Say("Aye, water, m'lord. For my brother. He is very sick. He's needin' drink. He's burnin' up. I am sick myself but still able to move, a little. I must [" .. eq.say_link("take this water to him") .. "] before he gets worse.");
