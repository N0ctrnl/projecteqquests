...
function event_say(e)
	...
	elseif(e.message:findi("war")) then
		e.self:Say("The war I speak of is the one we Steel Warriors have sworn to wage agianst [" .. eq.say_link("Clean Deathfist") .. "] in the Commonlands. We are doing a fine job but we require more weapons. We are expecting a shipment of blades from Groflahs Forge. We require a warrior of the bunker to [" .. eq.say_link("I will get your shipment",false,"get our shipment") .. "]. Maybe you.");
