...
function event_say(e)
	...
	elseif(fac < 5) then
		if(e.message:findi("new warrior")) then
			e.self:Say("Good to know you chose the Bunker to train you. It is the home of The Steel Warriors. We find our inner strengths grow through battles and deeds to further our growth. Do you [" .. eq.say_link("seek deeds") .. "] or [" .. eq.say_link("crave battle") .. "]?");
		...
		elseif(e.message:findi("veteran")) then
			e.self:Say("I apologize for not knowing. I am new to the Bunker. I was a trainer at the Hall of Steel in Qeynos before this.  I left Qeynos in search of [" .. eq.say_link("Milea") .. "] and instead found myself joining the bunker's weaponmasters.");
		end
	elseif(fac == 5) then
