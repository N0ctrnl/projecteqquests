...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Ha ha! Hello to you too! I have got this crazy deck that I'm willing to give to those [" . quest::saylink("I am looking for a deck",0,"looking for a deck") . "]. Ha ha! Oo!");
  }
