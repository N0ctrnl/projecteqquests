...
sub EVENT_SAY {
  if($text =~/hail/i) {
    ...
    quest::say("It's about time a courier reached these wastelands of humanity. I have urgent news for the Dead. Take this message at once. Let no one stop you. Be on the lookout for the Feir'Dal [" . quest::saylink("Silent Watch") . "]! They have learned of our quest.");
