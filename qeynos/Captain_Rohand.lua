...
function event_say(e)
	...
	if(e.message:findi("hail")) then
		e.self:Say("Greetings, friend, and welcome to the Mermaid's Lure. Here, we sell fishing supplies and some imported goods from far-off lands. And, if you've got a few minutes, I could even tell you a [" .. eq.say_link("What story?",false,"story") .. "] or two.");
	elseif(e.message:findi("story")) then
		e.self:Say("Stories? Stories? I saw more adventure before I was ten years tall than you'll see in your whole miserable existence. I've been everywhere, [" .. eq.say_link("Tell me about Odus",false,"Odus") .. "], [" .. eq.say_link("Tell me about Faydwer",false,"Faydwer") .. "], [" .. eq.say_link("Tell me about Kunark",false,"Kunark") .. "]. . . You name it, and I can tell ya a little something 'bout it. . . If you buy me a sip of brandy, of course!");
