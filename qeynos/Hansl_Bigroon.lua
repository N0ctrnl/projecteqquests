...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say(string.format("Greetings, %s! Are you a [" .. eq.say_link("I am a citizen of Qeynos",false,"citizen of Qeynos") .. "] or are you a [" .. eq.say_link("I am a traveler of sorts",false,"traveler of sorts") .. "]?",e.other:GetName()));
	...
	elseif(e.message:findi("erudin")) then
		e.self:Say("The trip to Erudin takes far too long. I have been designing a [" .. eq.say_link("What titanic bridge?",false,"titanic bridge") .. "] which will shorten the trip. Well, I cannot take full credit, most of the plans are being designed by [" .. eq.say_link("What three great engineers?",false,"three great engineers") .. "].");
	...
	elseif(e.message:findi("citizen of qeynos")) then
		e.self:Say("Then you are aware of how few ships come and go to the continent of Erudin. The port authority is even planning to tax all passage aboard the ships. You will be happy to know that a few other engineers and I are designing a [" .. eq.say_link("What titanic bridge?",false,"titanic bridge") .. "].");
