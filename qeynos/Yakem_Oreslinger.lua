...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say(string.format("Greetings friend %s! I am a provider of the highest quality steel ore known to Norrath! This ore is in such demand that I often run low and find it difficult to restock my supplies. If you're [" .. eq.say_link("I am looking for a job",false,"looking for a job") .. "] I will gladly pay you for some of your time.",e.other:GetName()));
