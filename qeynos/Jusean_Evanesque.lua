...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Why, hello there, " .. e.other:GetName() .. "! I am Jusean, loyal member of the League of Antonican Bards. You look like the reliable sort, maybe you could help me out for a bit, huh? It's about time for our field agents to turn in their [" .. eq.say_link("What watch reports?",false,"watch reports") .. "], and I need someone to go pick them up for me.");
	elseif(e.message:findi("watch report")) then
		e.self:Say("We always have someone stationed on watch duty at the two main entries to the city to keep an eye on what is happening around Qeynos. We have [" .. eq.say_link("Who are Anehan and Behroe?",false,"Anehan and Behroe") .. "] down at the docks, and [" .. eq.say_link("Who are Leanon and Quinon",false,"Leanon and Quinon") .. "] working the North Gate.");
