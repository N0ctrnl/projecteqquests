...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings and salutations "..e.other:GetName()..". I am Miltiades Tal`Azroth Crusader of Karana. I have spent all of my years here in Qeynos and gathered infinite knowledge from my teachers on my path to enlightenment. I have also started training new recruits to help them find their calling as a Holy Warrior of Karana. If you are a [" .. eq.say_link("I am a Paladin of Karana",false,"Paladin of Karana") .. "] I might have some tasks for you to complete.");
	elseif(e.message:findi("paladin of karana")) then
		e.self:Say("That is excellent news "..e.other:GetName()..". As a Knight in training of Karana I would like to offer you a series of [" .. eq.say_link("What tests?",false,"tests") .. "] what will test your devotion to yourself and your god.");
	elseif(e.message:findi("test")) then
		e.self:Say("I have put together a series of tests that will enable our new recruits to create their own armor. You will use a Rainkeepers Assembly Kit to combine assorted items that you will collect from both the hunting areas surround Qeynos and the city itself. Combining these magical items in your kit will create a material that you will place in a forge along with molds that I will present to you to create your armor. Are you ready to start [" .. eq.say_link("I am ready to start fashioning your materials",false,"fashioning your materials") .. "]?");
	elseif(e.message:findi("fashioning your materials")) then
		e.self:Say("Excellent "..e.other:GetName()..". Please take this Rainkeepers Assembly Kit. Now for your materials you will fashion you will obviously need to know what items are used for what armor materials. Simply tell me what armor piece you want to create and I will present you with the recipe for that specific armor material. I can present you with the molds and recipes necessary for creating Rainkeeper [" .. eq.say_link("Helm",false,"Helm") .. "], [" .. eq.say_link("Bracers",false,"Bracers") .. "], [" .. eq.say_link("Armguards",false,"Armguards") .. "], [" .. eq.say_link("Boots",false,"Boots") .. "], [" .. eq.say_link("Greaves",false,"Greaves") .. "], [" .. eq.say_link("Gaunlets",false,"Gauntlets") .. "] and [" .. eq.say_link("Breastplate",false,"Breastplate") .. "].");
