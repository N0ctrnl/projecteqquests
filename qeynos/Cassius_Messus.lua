...
function event_say(e)
  if(e.message:findi("hail")) then
    e.self:Say("Hail!  What do think of [" .. eq.say_link("Who is Lisera?",false,"Lisera") .. "]?  She aint' much to look at, but soon she will be singing again.");
  elseif(e.message:findi("Lisera")) then
    e.self:Say("Lisera is my lute.  She sounds horrible.  I need to get her tuned by a master tuner, but the League's Master Tuner is in the Plains of Karana for a while.  If only..  hey!!  You look like a fellow bard...  You [" .. eq.say_link("I am interested in the job",false,"interested in the job") .. "]?");
