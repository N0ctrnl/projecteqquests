...
function event_say(e)
	...
	elseif(e.message:findi("low")) then
		e.self:Say("This is going to sound crazy, but my main supplier of [" .. eq.say_link("What Blackburrow Stout?",false,"Blackburrow Scout") .. "] is one of the brewers themselves. I have run too low on the fine brew and need someone to [" .. eq.say_link("I will pick up your shipment",false,"pick up my shipment") .. "].");
...
function event_waypoint_arrive(e)
	if(e.wp == 5) then
		e.self:Say("Blast!! We are running [" .. eq.say_link("Why are you running low?",false,"low") .. "]!!");
	end
end
