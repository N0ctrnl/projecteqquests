...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings!!  Moran here.  I just love this city.  I traveled from Freeport to Qeynos to stay far from the [" .. eq.say_link("What is the Freeport Militia?",false,"Freeport Militia") .. "].");
