...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hello, there! I am Sollari Bekines of the League of Antonican Bards. I am at your service to train you as best I can. There have been a number of young bards entering our concert halls lately seeking guidance. If you are a [" .. eq.say_link("I am a young bard in search of training",false,"young bard in search of training") .. "]. I might have some work for you.");
	elseif(e.message:findi("young bard in search of training")) then
		e.self:Say("You need to look no further then. I can surely provide you with the knowledge you will need to make it in this world as a songweaver. The exercises that you will need to complete will test your gathering and fighting skills. Once you have completed your training you will be outfitted with a suit of your very own armor! When you are [" .. eq.say_link("I am ready to begin",false,"ready to begin") .. "] I will explain to you how the training will work.");
	elseif(e.message:findi("i am ready to begin")) then
		e.self:Say("Here is your Wind Spirits Assembly Kit. In this kit you will collect a different items that will be combined in certain quantities to create infused armor materials. These armor materials that you create can then be taken to a forge along with the applicable armor mold to fashion together a piece of Wind Spirits Armor. When you would like to craft an armor piece you must simply tell me what piece you want to craft. I will then provide you with the recipe and mold necessary for creating Wind Spirits [" .. eq.say_link("Helms",false,"Helms") .. "], [" .. eq.say_link("Bracers",false,"Bracers") .. "], [" .. eq.say_link("Armguards",false,"Armguards") .. "], [" .. eq.say_link("Boots",false,"Boots") .. "], [" .. eq.say_link("Greaves",false,"Greaves") .. "], [" .. eq.say_link("Gauntlets",false,"Gauntlets") .. "] and [" .. eq.say_link("Breastplates",false,"Breastplates") .. "].");
	...
	elseif(e.message:findi("breastplate")) then
		e.self:Say("To create your breastplate material you will need to combine 5 Bricks of Crude Iron, 1 Low Quality Bear Skin, 1 Woven Spider Silk, 1 Lock of Scarecrow Straw, 1 Matted Lion Pelt and 1 Bandit Sash in your assembly kit. Once you have created the proper material take it to a forge along with this mold to fashion your very own Wind Spirits Breastplate. When you are finished with your Breastplate and have completed your armor set please come see me for one [" .. eq.say_link("What final exercise?",false,"final exercise") .. "].");
