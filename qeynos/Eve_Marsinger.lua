...
function event_say(e)
	...
	elseif(e.message:findi("interested")) then
		e.self:Say("'I have messages that need to go to - well, right now I have one that needs to go to Highpass. Will you [" .. eq.say_link("I will deliver to Highpass",false,"deliver") .. "] mail to Highpass for me?");
	...
	elseif(e.message:findi("mail")) then
		e.self:Say("'The League of Antonican Bards has a courier system made up of travelers, adventurers and [" .. eq.say_link("What agents?",false,"agents") .. "]. We pay good gold to anyone who will take messages from bards such as myself to one of our more distant offices. Are you [" .. eq.say_link("I am interested",false,"interested") .. "]");
