...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 8969})) then -- Letter to Elishia
		e.self:Say("Oh, a letter from my grandson? Thank you very much. I haven't been able to talk to him recently. Would you mind taking a [" .. eq.say_link("I will take the letter back to him",false,"letter back to him") .. "] for me?");
		e.other:Ding();
