...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hail and well met, " .. e.other:GetName() .. "!  Have you come to study. or can you [" .. eq.say_link("I will peform the task",false,"perform a task") .. "] for me this day?");
