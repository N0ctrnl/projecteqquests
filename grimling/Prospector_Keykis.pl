...
sub EVENT_SAY {
  ...
  if ($text=~/wealth of possibilities/i) {
    quest::say("Yes. I'm sure you already know the value of the ore. With the war against the Grimlings going so well, I've been sent to sample the purity of the remaining ore. Unfortunately, I'm not a warrior and it's almost impossible to retrieve the [" . quest::saylink("What samples?",0,"samples") . "] I need.");
  }
  if ($text=~/samples/i) {
