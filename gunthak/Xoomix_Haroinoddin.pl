...
sub EVENT_SAY { 
 if ($text=~/Hail/i){
  quest::say("Please. Please help me. I am quite weak and am being [" . quest::saylink("held captive") . "] here against my will");
 }
 ...
 if ($text=~/tools/i) {
   quest::say("Well, I have many tools that I have either lost while in this place or that were taken from me because the guards felt they had too much value for me to possess them. I also need my gearbox from back home to construct my compass that I need to escape this place. I could set sail anytime I want, but I did not want to risk setting out to sea and dying alone because I didn't know my bearings. If you could [" . quest::saylink("I will find your possessions",0,"find my possessions") . "] then I could make something that Golsodix would know came from me and he could give you my gearbox.");
 }
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 21979 => 1)) {
    quest::say("Brell be praised. Golsodix sent you didn't he? If only I had my [" . quest::saylink("What tools?",0,"tools") . "] I could go see him again.");
  }
    ...
    quest::summonitem(21984); # Item: Tinkered Contraption
  }
    ...
    quest::summonitem(61003); # Item: Xoomix`s Mystical Charm
    quest::exp(100);
  }
