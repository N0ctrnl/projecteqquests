...
sub EVENT_SAY {
 if($text=~/hail/i){
  ...
  quest::emote("'s soiled face shines with a glint of hope. 'You know my name? Who has [" . quest::saylink("Master Rinmark sent me",0,"sent") . "] you to find me?'");
 }
 elsif($text=~/master rinmark sent/i){
  quest::say("Then word has gotten to him!! If you be a monk of the third rung I will accept your aid. You must find the [" . quest::saylink("coppernickel key") . "]. It is required to release me from this goblin shackle. I have no reward to offer other than the shackle of steel. Give me both your shackles of the third rung along with the key and I shall reward you the first shackle of the fourth rung.");
 }
