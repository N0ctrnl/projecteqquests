...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 18173})) then
		e.self:Say("Gans sent you to check on me did he? Well you can tell my dear brother that the surveying has been halted. One of those furballs has stolen my tools, making my job impossible. Kerrans, kobolds, gnolls, we're constantly under siege by these primitives. Anyway, perhaps you could [" .. eq.say_link("I will help you",false,"help me") .. "]?");
		e.other:Ding();
		e.other:AddEXP(150);
