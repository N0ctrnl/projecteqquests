# items: 4491, 4940, 4949, 4950, 3757, 4992, 4951, 4952, 3758, 4994, 4955, 4956, 4957, 3760, 4490, 4938, 4939, 3756, 4488, 4959, 4960, 3761, 4494, 4953, 4954, 3759

sub EVENT_SAY { 
  if($text=~/Hail/i){
    quest::say("Sarah Jelnen closes her eyes and sighs wistfully as if remembering some long forgotten bittersweet memory. 'Hafron must have told you about our dearly missed friend Hadon. Very well, are you a [" . quest::saylink("I am a shaman",0,"shaman") . "]?");
  }
  if($text=~/shaman/i){
    quest::say("Aye you have the look of one who communes with spirits. The pieces that I have are the [" . quest::saylink("mask",0,"mask") . "], [" . quest::saylink("cloak",0,"cloak") . "], [" . quest::saylink("gauntlets",0,"gauntlets") . "], [" . quest::saylink("talisman",0,"talisman") . "], [" . quest::saylink("girdle",0,"girdle") . "] and [" . quest::saylink("spear",0,"spear") . "].");
  }
  if($text=~/cloak/i){
