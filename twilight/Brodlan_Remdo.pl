# Dark Knight's Armor
# items: 4489, 5871, 5872, 3965, 4488, 5869, 5870, 3964, 4491, 5857, 5860, 5859, 3960, 4494, 5864, 5865, 5866, 3962, 4490, 5854, 5855, 5856, 3959, 5873, 5874, 3966, 5867, 5868, 3963, 4492, 5861, 5862, 5863, 3961

sub EVENT_SAY { 
  if($text=~/Hail/i){
    quest::say("Why hello. I'm in charge of the fishing operations here on Jern's Isle. [" . quest::saylink("What fish?",0,"Fish") . "] are my area of expertise.'");
  }
  if($text=~/what fish/i){
    quest::say("We have fish come in here all the time. Sometimes we catch an [" . quest::saylink("What oddity?",0,"oddity") . "] now and again.");
  }
  if($text=~/what oddity/i){
    quest::say("Once we pulled up this ancient chest filled with this [" . quest::saylink("What dark plate armor?",0,"dark plate armor") . "].");
  }
  if($text=~/what dark plate armor/i){
    quest::say("Looked the like kind of armor a dark knight would wear. if ya want it I'm sure we could arrange a [" . quest::saylink("What trade?",0,"trade") . "] of some sort.");
  }
  if($text=~/what trade/i){
    quest::say("Since Trevor and I are the ones that found it we split it between ourselves. I have a [" . quest::saylink("helm",0,"helm") . "], [" . quest::saylink("breastplate",0,"breastplate") . "], [" . quest::saylink("vambraces",0,"vambraces") . "], [" . quest::saylink("greaves",0,"greaves") . "], [" . quest::saylink("pauldrons",0,"pauldrons") . "], [" . quest::saylink("bracer",0,"bracer") . "], and [" . quest::saylink("boots",0,"boots") . "]. Ask Trevor about the rest of the armor.");
  }
