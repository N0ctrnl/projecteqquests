...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say(string.format("Greetings, %s. Welcome to the Miller Farmstead. [" .. eq.say_link("Who is Cleet?",false,"Cleet") .. "] and I have lived out here on the plains of Karana for thirty years now. We grow the finest grains in all of Norrath. Admire the grains all you like, but steer clear of those [" .. eq.say_link("What scarecrows?",false,"scarecrows") .. "].",e.other:GetName()));
