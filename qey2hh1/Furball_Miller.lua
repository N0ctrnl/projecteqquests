function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("<BARK!>  Hiya!  <Bark!>  <Bark!>  My name is Furball Miller.  I work here on my father's farm. Of course, he is not my real father but he is the one who raisd me from a pup.  I hope to go back to [" .. eq.say_link("What is Blackburrow?",false,"Blackburrow") .. "] some day and try to get them to stop all the senseless fighting with the humans of Qeynos.");
