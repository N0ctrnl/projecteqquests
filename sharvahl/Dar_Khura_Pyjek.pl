...
sub EVENT_SAY {
  if ($text =~ /hail/i) {
    quest::say("And hail to you adventurer. It is good to see one willing to brave the craters. I must warn you that there are deadly [" . quest::saylink("What scorpions?",0,"scorpions") . "] all around these parts. Some of them are quite large indeed, and their poison can be very deadly.")
  }
  elsif ($text =~ /scorpions/i) {
    quest::say("It would be a great help if you assist us in reducing their numbers. As their numbers grow, more and more of them venture into our city and endanger our citizens. [" . quest::saylink("Who is Spiritualist Ragnar?",0,"Spiritualist Ragnar") . "] has supplied me with the means to create an anti venom, but I will need one of their stingers in order to do so. If you bring one of their stingers to me, I will cure you of such poisons.")
  }
  elsif ($text =~ /spiritist ragnar/i) {
    quest::say("Spiritist Ragnar is the owner of the alchemy shop in the merchants quarters. He has been researching the venom of the whiptail scorpions. If you happen to find any of their glands, it would be a tremendous help to him if you could supply him with some of these glands. Use caution, for there is a deadly one still roaming out there. We call him [" . quest::saylink("Who is Tailfang?",0,"Tailfang") . "]. I would suggest steering clear of this little sucker? he is particularly nasty.")
  }
