...
sub EVENT_ITEM { 
  ...
  if(plugin::check_handin(\%itemcount, 3493 => 1)){
    ...
    quest::say("Citizens often need assistance and the Dar Khura must be available whenever possible. [" . quest::saylink("Who is Merchant Ayyad?",0,"Merchant Ayyad") . "] has requested someone to run an errand and I am sending you. Return to me with Ayyad's seal, the hide treatment, your buckler, and your initiate's cloak.");
