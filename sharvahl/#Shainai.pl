...
sub EVENT_SPAWN {
  quest::signalwith(155041,2,10); # NPC: #Delival
}
...
sub EVENT_SAY {
  ...
  if((($wp > 16) && ($wp < 61)) && ($text=~/Hail/i)){
    quest::say("Hi. I was getting some buttons for Daddy and I got a little lost. I know the way, I mean it...but if you wanted to [" . quest::saylink("I will follow you",0,"follow") . "] me home to make sure I got there safe and all, you could.");
  }
  if((($wp > 16) && ($wp < 61)) && ($text=~/follow/i)){
    ...
    quest::ding();
    quest::summonitem(4460); # Item: Shainai's Bag
  }
