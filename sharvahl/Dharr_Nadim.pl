...
sub EVENT_SAY {
  if($text=~/Hail/i){   
    quest::say("Step up. step up! Please take a moment to purchase some supplies from me. Times are hard and my [" . quest::saylink("What bad luck?",0,"luck") . "] has been bad."); 
  }
  if($text=~/luck/i){   
    quest::say("I have just come from Hollowshade Moor a few weeks ago. My fishing days have been very unprosperous. The lures that I have now are made of low quality Acrylia and scare the fish away rather than attract them. I want to make a new lure, and on my way in I noticed the dull color of the [" . quest::saylink("What scorpions?",0,"scorpions") . "]. I would have moved closer to them but unfortunately I am deathly allergic to the poisons found in scorpion venom."); 
  }
  if($text=~/scorpions/i){   
