...
sub EVENT_SIGNAL {
  if($signal==1) {
    quest::emote("sighs and says, 'My hands are full right now hon.'  Delival looks your way curiously and asks, 'I don't suppose you would want to [" . quest::saylink("I will tuck her in",0,"tuck") . "] her in for me if I give you a blanket?'");
  }
  if($signal==2) {
