...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount,2877=>1)){
    quest::say("Ah good I was hoping you'd be along soon. I need you to collect some Gravel tea leaves from below the city. I need these leaves to make some tea for the guards under the arena. I need 10 of these leaves to brew enough tea for the guards. Take this pouch and fill it with leaves and return it to me.");
    quest::summonitem(17098); # Item: Empty Pouch
  }
  if(plugin::check_handin(\%itemcount,31764=>1)){
    quest::say("Many thanks $name, I'll be going to brew this tea up for the guards now. Take this seal as proof of your helping me. You wouldn't happen to know anyone who would be [" . quest::saylink("I am interested",0,"interested") . "] in learning the art of Vah Shir Brewing would you? I could really use the help in these hard times, I can barely keep up with all the demand.");
    quest::summonitem(31774); # Item: Ahlam's seal
  }
  if(plugin::check_handin(\%itemcount,31774=>1)){
    quest::say("Well done, it is now time to start down the path of learning the art of Vah Shir brewing. You'll need a steady hand if you are to master the brew barrel. The first thing you'll need to learn is how to purify the water we use for all our finest brews. Take this Acrylia filter and use it to [" . quest::saylink("How do I purify water?",0,"purify water") . "]. Bring me 4 flasks of crystal clear water and I'll teach you how to make the tea from the gravel tea leaves.");
    quest::summonitem(31760); # Item: Acrylia sand purifier
  }
  if(plugin::check_handin(\%itemcount,31762=>4)){
    quest::say("Very good $name, this water is perfect for making Gravel leaf tea. I've just received a message from Guard Jabbar under the arena needs a shipment of [" . quest::saylink("What Gravel leaf tea?",0,"Gravel leaf tea") . "] to help sedate the prisoners. Fill a crate with bottles of Gravel leaf tea and take it to Guard Jabbar.");
  }
  if(plugin::check_handin(\%itemcount,31775=>1)){
    quest::say("Very good $name, the guards had been waiting for that tea all day. I think you're ready to move on to something a bit more challenging now. Take this strainer, it will allow you to create some very potent brews from some of the more rare herbs to be found near the city. You'll want to start by making some [" . quest::saylink("What Hollow palm tea?",0,"Hollow palm tea") . "] to get used to how the strainer works.");
