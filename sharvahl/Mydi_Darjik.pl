...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 3495 => 1)) {
    ...
    quest::say("Sometimes I feel as if the spirits are playing tricks on me. I'm out of spores. I never seem to run out of spores until the times when I need them most. You'll need to gather them on your own to make the [" . quest::saylink("What soaking solution?",0,"soaking solution") . "].");
