...
sub EVENT_SAY {
  if($text=~/Hail/i) {
    quest::say("Hello there, $name. I do not suppose you have seen a little girl running around with a box of [" . quest::saylink("What buttons?",0,"buttons") . "]? I sent [" . quest::saylink("Who is Shainai?",0,"Shainai") . "] over to Master Barkhem's place so I can finish these uniforms I am working on.");
  }
  if($text=~/Shainai/i) {
    quest::say("Shainai is my little girl. While I am [" . quest::saylink("Why are you inactive?",0,"inactive") . "] I would like to see her as much as possible so I brought her with me here. I am starting to worry that she may have gotten lost near the palace. If you see her and have the time to escort her back here I would be indebted to you, friend.");
  }
  if($text=~/buttons/i) {
