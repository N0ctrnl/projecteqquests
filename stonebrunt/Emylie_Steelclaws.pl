...
sub EVENT_SAY {
  if($text=~/hail/i) {
    quest::say("Shalom friend. My mate Kalaaro is the primary blacksmith of our village. I mostly create his tools, do touch ups and refurbishes, and maintain the [" . quest::saylink("What kejek forge?",0,"kejek forge") . "].");
  }
