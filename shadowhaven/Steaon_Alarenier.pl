...
sub EVENT_SAY {
  if($text =~ /Hail/i) {
    quest::say("Hail $name. You will have to excuse me because I am quite busy with my work and trying to sort out my [" . quest::saylink("What deliveries?",0,"deliveries") . "]. However, please help yourself to anything in my store that may be to your liking.");
  }
  if($text =~ /deliveries/i) {
    quest::say("You see, I have to make more and more deliveries everyday, what with my business growing so much. I find it difficult to make time to go pick up the different skins and pelts I need for my trade. It's tough when you need some good help but can't afford to pay them. Sorry to bother you with my banter, perhaps I will find someone on the [" . quest::saylink("I am on my way to the Bazaar",0,"way to the Bazaar") . "].");
  }
  if($text =~ /way to the bazaar/i) {
    quest::say("You are, eh $name? Well then if you wanted to pick up some supplies for me and deliver them to my partner in the Bazaar I'm sure I would be very grateful. Would you like to make a [" . quest::saylink("I will make a trip to the Bazaar",0,"trip to the Bazaar") . "]?");
  }
