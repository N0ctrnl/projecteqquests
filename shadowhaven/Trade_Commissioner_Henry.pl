...
sub EVENT_SAY {
  ...
  if($text =~ /deliveries/i) {
    quest::say("The deliveries are simple enough, I just need you to bring some letters to some merchants of the Haven that are currently working in other locations. Will you [" . quest::saylink("I will deliver these letters",0,"deliver these letters") . "]?");
  }
