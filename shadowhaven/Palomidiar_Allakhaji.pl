...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Good day to you adventurer. Is there something I can assist you with? I have been quite busy as of late with the study of this [" . quest::saylink("What mysterious glowing rock?",0,"mysterious glowing rock") . "] I was presented with and I do not have much time for small talk.");
  }
  if ($text=~/mysterious glowing rock/i) {
    quest::say("Well, if you look closely, I have it right here. It has been glowing since I first received it. But since it was delivered to me it has lost a lot of it's aura. I feel I will need another sample soon, it seems to lose its [" . quest::saylink("What energy?",0,"energy") . "] as time goes on.");
  }
  if ($text=~/energy/i) {
    quest::say("This I do not know and I am trying to discover. However, as I said before, this rock is slowly losing its energy it seems. I will need another [" . quest::saylink("What sample rock?",0,"sample rock") . "] soon.");
  }
  if ($text=~/sample rock/i) {
    quest::say("I believe these rocks are from the Paludal Caverns, if my sources were correct. Beetles that crawl over and feed off the rock structures there might explain the glowing, if they are the origins of these mysterious rocks. To further my studies I will need another pulsating rock. Will you [" . quest::saylink("I will retrieve this rock",0,"retrieve this rock") . "] for me?");
  }
