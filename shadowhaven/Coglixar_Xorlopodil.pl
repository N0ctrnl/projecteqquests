...
sub EVENT_SAY {
  ...
  if ($text=~/assist/i) {
    quest::say("That is great to hear, $name. I have a task for you to complete for me first and if you are able to complete it I may have other things for you in the future. I have heard word that some of our dwarf workers in the [" . quest::saylink("What mining operation?",0,"mining operation") . "] are in need of some food.");
  }
