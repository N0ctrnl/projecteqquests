...
sub EVENT_SAY{
  ...
  if(!quest::istaskactive(211)){
    if(!defined $qglobals{halloween_black_cat}){
      if($text=~/Hail/i){
        quest::say("Please help me find my missing cat, she has gone astray and I can't seem to find her anywhere. Her name is Muffin. Will you [" . quest::saylink("I will help you",0,"help") . "] me? Oh please!");
      }
      if($text=~/help/i){
