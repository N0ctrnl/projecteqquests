...
sub EVENT_SAY {
  if(quest::istaskactive(19)){
    ...
    if(!defined $qglobals{halloween_hungry}){
      if($text=~/hail/i) {
        quest::say("Hail to you too. You wouldn't happen to have any of those wondrous [" . quest::saylink("What pumkiny foods?",0,"pumpkiny foods") . "] on you would you? I'm not really feel my best and nothing perks you up better than a nice bit of tasty pumpkin.");
      }
      if($text=~/Pumpkiny foods/i) {
        quest::say("The best of the best pumpkiny foods can be found in my personal book of home remedies. They may be a bit complicated to make, but you've never had anything tastier. I'd be happy to give you a copy of my book if you'd be [" . quest::saylink("I am willing",0,"willing") . "] to bring me the first couple of snacks you make.");
      }
      if($text=~/willing/i) {
