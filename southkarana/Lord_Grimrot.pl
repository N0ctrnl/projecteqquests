...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 12137 => 1)) {
    quest::say("The head for my commander. Let us see. I have a body ready for it. There. Hahahaha!! As for your fine work, take this. Also, I believe you can help me find my beloved [" . quest::saylink("Who is Arlena?",0,"Arlena") . "].");
