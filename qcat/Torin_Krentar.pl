...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 20207 => 1)) {
    quest::say("Well met young disciple of Bertoxxulous. Perhaps one day you shall serve the Plague Lord in his realm, but for now you will serve the Bloodsabers, his mortal agents on Norrath. The armor you seek must be assembled using this Mail Assembly Kit. The materials necessary to construct the armor vary depending on the piece being crafted. Do you wish to craft [" . quest::saylink("Gauntlets",0,"Gauntlets") . "] of the Pestilence Priests, [" . quest::saylink("Boots",0,"Boots") . "] of the Pestilence Priests, a [" . quest::saylink("Bracer",0,"Bracer") . "] of the Pestilence Priests, a [" . quest::saylink("Helm",0,"Helm") . "] of the Pestilence Priests, [" . quest::saylink("Greaves",0,"Greaves") . "] of the Pestilence Priests, [" . quest::saylink("Vambraces",0,"Vambraces") . "] of the Pestilence Priests, or a [" . quest::saylink("Breastplate",0,"Breastplate") . "] of the Pestilence Priests?");
