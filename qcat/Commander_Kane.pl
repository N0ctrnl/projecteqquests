...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    ...
    quest::say("Good to see you, my friend. S'ragg said he would be sending his finest. I pray he is right. Do you feel like [" . quest::saylink("I feel like going to Highpass",0,"going to Highpass") . "] or [" . quest::saylink("I am going home",0,"going home") . "]?");
