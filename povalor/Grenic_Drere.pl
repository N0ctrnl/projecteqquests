...
sub EVENT_SAY {
  ...
  if($text=~/situation/i) {
    quest::say("Not that it is your business, but this is where I call home. I have lost track of the years that I have spent here. This valley is my home, for I was exiled from [" . quest::saylink("What is Mithaniel's Temple?",0,"Mithaniel's Temple") . "]. It is not a story that I am proud of and do not wish to share with you. So be one with you.");
  }
  if($text=~/temple/i) {
    quest::say("Only a mortal would be as thick headed to know not when to take their leave. He and his legions call his temple The Halls of Honor. Paladins that have served him well on Norrath have the opportunity to ascend into his ranks. They are in training to make sure that they are always prepared to defend what they believe is the right and honorable thing to do. Mithaniel is an extremely proud being, and will accept any challenge that you may have to offer him. If you are willing to challenge him, I may have some [" . quest::saylink("What information?",0,"information") . "] you will find useful.");
  }
  if($text=~/information/i) {
    quest::say("There are other methods to enter the Halls of Honor than those that are readily apparent, and as a former soldier of Marr I can offer you access into the Halls; however as with all such arrangements there must be something [" . quest::saylink("What must be paid?",0,"paid") . "] for something earned.");
  }
  if($text=~/paid/i) {
