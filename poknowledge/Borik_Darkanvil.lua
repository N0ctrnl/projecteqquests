...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings, Borik Darkanvil, at your service. I was once a planar traveler like you. Those days are behind me, now I am content to earn my keep as a blacksmith, and to experiment with some of the [" .. eq.say_link("What special recipe?",false,"special recipe") .. "] that I have picked up in these outer planes");
