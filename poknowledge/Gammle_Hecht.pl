...
sub EVENT_SAY { 
if($text=~/Hail/i){
      quest::say("Good day $name.  I don't mean to be curt but I have much work to do to be ready for my museum display, and there is not much time left. I expect many young warriors to be visiting here, but it is unfortunate that I do not have the final pieces I am [" . quest::saylink("What are you missing?",0,"missing") . "]. They would add to the collection greatly.");
   }elsif($text=~/missing/i){
      quest::say("If you would be willing to help me, I can make it worth your while. I need you to find a Minotaur Battle Axe, Goblin Two-Handed Sword, Chill Dagger, and an Ancient Sensate Shield. When you get these items, put them in a Collector's Box that you can get from [" . quest::saylink("Who is Merri?",0,"Merri") . "], close it up and bring it to me.");
	  }elsif($text=~/merri/i){
