...
sub EVENT_SAY {
  if($text=~/hail/i) {
    quest::say("Hello, $name. If you are looking for something in particular, I might be able to help you. I spent many years teaching combat techniques to the finest warriors in Grobb. I came to New Tanaan to further develop my teaching skills; it seems we all have our own lessons to learn. I can teach you a few things if you are looking to be taught. I will teach you the basics of planar combat if you are [" . quest::saylink("I am willing to learn",0,"willing to learn") . "].");
  }
  if($text=~/willing to learn/i) {
    quest::say("This is good. One of the most important aspects to your battle readiness is your strong willpower and bravery. Years ago I discovered a particular concoction that will very readily put your willpower to the test. Unfortunately I ran out not too long ago and I am in need of some more [" . quest::saylink("What is Planar Blood Brew?",0,"Planar Blood Brew") . "]. If you can make some more for my students, it would certainly look favorably upon you in your future teachings. Bring me some along with your Planar Traveler's Manual.");
  }
