...
sub EVENT_SAY { 
	if($text=~/Hail/i){
		quest::say("I am afraid I have little that I can talk about right now.  If you like you may speak to my [" . quest::saylink("Who is your instructor?",0,"instructor") . "] he can probably tell you about our work.");
	}
