...
sub EVENT_SAY {
  ...
  if($text=~/listen/i) {
    quest::say("I have come to Knowledge to fine-tune my abilities in spell craft. To date I've been able to create some minor incantations, but have had little success in creating any magic that was truly revolutionary. I am actually in a bit of a race with the other Sages who are my contemporaries. They too are looking to make a major breakthrough . . . Come to think of it, I could probably find quite a few [" . quest::saylink("What uses for their research?",0,"uses for their research") . "], should you manage to come by any of it.");
