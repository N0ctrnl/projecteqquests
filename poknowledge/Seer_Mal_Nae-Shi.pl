sub EVENT_SAY {
  if($text=~/Hail/i) {
    quest::say("Greetings, $name. I can provide you information upon your travels through the planes by [" . quest::saylink("guided meditation",0,"guided meditation") . "].");
  }
  if($text=~/guided meditation/i) {
    ...
    $client->Message(9,"Now that your thoughts have calmed, tell me where you have traveled... There are many planes, try to think about your past, and your adventures in: [" . quest::saylink("Plane of Nightmare",0,"Plane of Nightmare") . "] [" . quest::saylink("Plane of Innovation",0,"Plane of Innovation") . "] [" . quest::saylink("Plane of Disease",0,"Plane of Diseae") . "] [" . quest::saylink("Plane of Valor",0,"Plane of Valor") . "] [" . quest::saylink("Plane of Storms",0,"Plane of Storms") . "] [" . quest::saylink("Plane of Torment",0,"Plane of Torment") . "] [" . quest::saylink("Ruins of Lxanvom ",0,"Ruins of Lxanvom") . "] [" . quest::saylink("Doomfire, the Burning Lands",0,"Doomfire, the Burning Lands") . "] [" . quest::saylink("Drunder, Fortress of Zek",0,"Drunder, Fortress of Zek") . "] [" . quest::saylink("Eryslai, the Kingdom of Wind",0,"Eryslai, the Kingdom of Wind") . "] [" . quest::saylink("Halls of Honor",0,"Halls of Honor") . "] [" . quest::saylink("Lair of Terris Thule",0,"Lair of Terris Thule") . "] [" . quest::saylink("Bastion of Thunder",0,"Torden, the Bastion of Thunder") . "] [" . quest::saylink("Reef of Coirnav",0,"Reef of Coirnav") . "] [" . quest::saylink("Tower of Solusek Ro",0,"Tower of Solusek Ro") . "] [" . quest::saylink("Vegarlson, the Earthen Badlands",0,"Vegarlson, the Earthen Badlands") . "] [" . quest::saylink("Ragrax, Stronghold of the Twelve",0,"Ragrax, Stronghold of the Twelve") . "] [" . quest::saylink("Temple of Marr",0,"Temple of Marr") . "].  If you have completed your elemental flag, say [" . quest::saylink("elemental flag",0,"elemental flag") . "]");
    $client->Message(9,"If one option does not give you the information you need, you may be missing experience from some zones.  To find the credit you currently have, please just [" . quest::saylink("unlock memories",0,"unlock memories") . "].");
    $client->Message(9,"There are special restrictions for the Temple of Marr, elemental planes, and Plane of Torment.  If you need assistance, say [" . quest::saylink("special zones",0,"special zones") . "].");
  }
  if($text=~/special zones/i) {
    $client->Message(9,"The Temple of Marr is a special access zone.  To access the Temple of Marr you must kill Bertox, Terris Thule, complete the three trials within Halls of Honor, and defeat Saryrn. The other special access zones are the elemental planes. These planes are Plane of Air, Plane of Water and Plane of Earth. To inquire about access to elemental planes, say [" . quest::saylink("elemental planes",0,"elemental planes") . "]. To access the elemental planes: Plane of Fire is obtained by killing through the plane of innovation, to Drunder, Fortress of Zek, then to the Tower of Soluesk Ro, where you must kill Solusek Ro himself.  To access the other elemental planes, you must have completed ALL zone flags in lower zones, and kill Agnarr the storm lord, and Mithaniel Marr. To inquire about access to the Temple of Marr, say [" . quest::saylink("Access to Temple of Marr",0,"Access to Temple of Marr") . "]. The last special access zone is the Plane of Torment. You must have killed Terris Thule and Bertox before you can enter to kill Saryrn. To inquire about the Plane of Torment, say [" . quest::saylink("access to Torment",0,"access to Torment") . "]."); 
...
##############################################################################################################################
    ...
    if($text=~/Plane of Innovation/i && defined $qglobals{pop_poi_behometh_preflag} && defined $qglobals{pop_poi_behometh_flag} ) {
      $client->Message(4,"You have halted production of these evil machines by Killing the Behemoth! Converse with the Planar projection by saying [The War Drum Echo]");
    }
##############################################################################################################################
##############################################################################################################################
...
##############################################################################################################################
    ...
    if($text=~/Plane of Justice/i && defined $qglobals{pop_poj_mavuin} && defined $qglobals{pop_poj_tribunal} && defined $qglobals{pop_poj_valor_storms}) {
      $client->Message(4,"Congratulations! Converse with the Planar Projection by saying [I am familiar with the Order] to receive access to Planes of Valor and Storms.");
    }
############################################################################################################################## 
##############################################################################################################################
...
##############################################################################################################################
    if($text=~/Plane of Valor/i && (!defined $qglobals{pop_pov_aerin_dar})) {
      if(defined $qglobals{pop_pov_aerin_dar}) {
        ...
        $client->Message(9,"You have NOT defeated the prismatic dragon, Aerin`Dar, within the Plane of Valor.  Make sure you have completed a [" . quest::saylink("Plane of Justice",0,"Plane of Justice") . "] Trial.");
      }
    }
...
##############################################################################################################################
    if($text=~/Plane of Storms/i && (!defined $qglobals{pop_pos_askr_the_lost} || !defined $qglobals{pop_pos_askr_the_lost})) {
      ...
      if(defined $qglobals{pop_pos_askr_the_lost_final}) {
        ...
        $client->Message(9,"You have NOT killed the giants within the Plane of Storms to complete Askr's task. Make sure you have completed a [" . quest::saylink("Plane of Justice",0,"Plane of Justice") . "] Trial.");
      }
    }
    if($text=~/Plane of Storms/i && defined $qglobals{pop_poj_mavuin} && defined $qglobals{pop_poj_tribunal} && defined $qglobals{pop_poj_valor_storms} && $qglobals{pop_pos_askr_the_lost} == 3 && $qglobals{pop_pos_askr_the_lost} == 3) {
      $client->Message(4,"Congratulations! Converse with the Planar Projection by saying [I will defeat the Stormlord] to gain access to the Bastion of Thunder");
    } 
############################################################################################################################## 
##############################################################################################################################
...
##############################################################################################################################
    if($text=~/Lair of Terris Thule/i && (!defined $qglobals{pop_ponb_terris} || !defined $qglobals{pop_ponb_poxbourne})) {
      ...
      $client->Message(9,"You have NOT talked to Poxbourne in the Plane of Tranquility after defeating Terris Thule.  Make sure you have completed the events within the [" . quest::saylink("Plane of Nightmare",0,"Plane of Nightmare") . "].");
      }
    }
    if($text=~/Lair of Terris Thule/i && defined $qglobals{pop_ponb_terris} && defined $qglobals{pop_ponb_poxbourne} && defined $qglobals{pop_pon_hedge_jezith} && defined $qglobals{pop_pon_construct}) {
      $client->Message(4,"You have completed a partial flag for the Plane of Torment! Say [" . quest::saylink("access to Torment",0,"access to Torment") . "] to see what else is required.");
    }	
##############################################################################################################################
##############################################################################################################################
...
##############################################################################################################################
    if($text=~/Ruins of Lxanvom/i && (!defined $qglobals{pop_cod_preflag} || !defined $qglobals{pop_cod_bertox} || !defined $qglobals{pop_cod_final})) {
      ...
      if(defined $qglobals{pop_cod_bertox}) {
        ...
        $client->Message(9,"You have NOT killed Bertox and hailed the planar projection.  Make sure you have completed the events within [" . quest::saylink("Plane of Disease",0,"Plane of Disease") . "]");
      }
      if(defined $qglobals{pop_cod_final}) {
        $client->Message(12,"You have killed Bertox and talked to Adler Fuirstel");
      } else {
        $client->Message(9,"You have NOT talked to Adler Fuirstel after killing Bertox.  Make sure you have completed the events within [" . quest::saylink("Plane of Disease",0,"Plane of Disease") . "]");
      }
    }
...
##############################################################################################################################
    if($text=~/Plane of Torment/i && (!defined $qglobals{pop_pot_shadyglade} || !defined $qglobals{pop_pot_newleaf} || !defined $qglobals{pop_pot_saryrn} || !defined $qglobals{pop_pot_saryrn_final})) {
      ...
      if(defined $qglobals{pop_pot_saryrn_final}) {
        $client->Message(12,"You have killed Saryrn, hailed the planar projection, and then talked to Shadyglade once more. Please make sure you have completed events within [" . quest::saylink("[Plane of Nightmare",0,"[Plane of Nightmare") . "] [" . quest::saylink("Plane of Disease",0,"Plane of Disease") . "] [" . quest::saylink("Halls of Honor",0,"Halls of Honor") . "] [" . quest::saylink("Lair of Terris Thule",0,"Lair of Terris Thule") . "] [" . quest::saylink("Ruins of Lxanvom",0,"Ruins of Lxanvom") . "] [" . quest::saylink("Plane of Storms",0,"Plane of Storms") . "] to advance to the Temple of Marr.");
      } else {
        $client->Message(9,"You have NOT talked to Shadyglade after killing Saryrn. Please make sure you have completed events within [" . quest::saylink("Plane of Nightmare",0,"Plane of Nightmare") . "] [" . quest::saylink("Plane of Disease",0,"Plane of Disease") . "] [" . quest::saylink("Halls of Honor",0,"Halls of Honor") . "] [" . quest::saylink("Lair of Terris Thule",0,"Lair of Terris Thule") . "] [" . quest::saylink("Ruins of Lxanvom",0,"Ruins of Lxanvom") . "] [" . quest::saylink("Plane of Storms",0,"Plane of Storms") . "] to advance to the Temple of Marr.");
      }
    }
    if($text=~/Plane of Torment/i && defined $qglobals{pop_pot_shadyglade} && defined $qglobals{pop_pot_newleaf} && defined $qglobals{pop_pot_saryrn} && defined $qglobals{pop_pot_saryrn_final}) {
...
##############################################################################################################################
    ...
    if($text=~/Fortress of Zek/i && (!defined $qglobals{pop_tactics_tallon} || !defined $qglobals{pop_tactics_vallon} || !defined $qglobals{pop_tactics_ralloz})) {
      ...
      if(defined $qglobals{pop_tactics_ralloz}) {
        ...
        $client->Message(9,"You have NOT killed Rallos Zek the Warlord.  Make sure you have completed the [" . quest::saylink("Plane of Innovation",0,"Plane of Innovation") . "] flags");
      }
    }
...
##############################################################################################################################
    if($text=~/Tower of Solusek Ro/i && (!defined $qglobals{pop_sol_ro_arlyxir} || !defined $qglobals{pop_sol_ro_dresolik} || !defined $qglobals{pop_sol_ro_jiva} || !defined $qglobals{pop_sol_ro_xuzl} || !defined $qglobals{pop_sol_ro_rizlona} || !defined $qglobals{pop_sol_ro_solusk})) {
      ...
      if(defined $qglobals{pop_sol_ro_solusk}) {
        $client->Message(12,"You have defeated Solusek Ro within his own tower.  Please make sure you've completed events in the [" . quest::saylink("Plane of Innovation",0,"Plane of Innovation") . "] and [Drunder, Fortress of Zek]."); 
      } else {
        $client->Message(9,"You have NOT defeated Solusek Ro within the Tower of Solusek Ro.  Please make sure youve completed events in the [" . quest::saylink("Plane of Innovation",0,"Plane of Innovation") . "] and [Drunder, Fortress of Zek].");
      }
    }
    if($text=~/Tower of Solusek Ro/i && defined $qglobals{pop_sol_ro_arlyxir} && defined $qglobals{pop_sol_ro_dresolik} && defined $qglobals{pop_sol_ro_jiva} && defined $qglobals{pop_sol_ro_xuzl} && defined $qglobals{pop_sol_ro_rizlona} && defined $qglobals{pop_sol_ro_solusk}) {
...
##############################################################################################################################
    ...
    if($text=~/of thunder/i && defined $qglobals{pop_bot_agnarr}) {
      $client->Message(4,"You have defeated Agnarr, the Storm Lord! This is part of the elemental flag! Once you are finished with the elemental flag, let me know by saying [" . quest::saylink("elemental flag",0,"elemental flag") . "].");
    }
##############################################################################################################################
##############################################################################################################################
...
##############################################################################################################################
    ...
    if($text=~/temple of/i && defined $qglobals{pop_hohb_marr}) {
      $client->Message(4,"You have defeated Lord Mithaniel Marr!  This is part of the elemental flag! Once you are finnished with the elemental flag, let me know by saying [" . quest::saylink("elemental flag",0,"elemental flag") . "].");
    }
##############################################################################################################################
##############################################################################################################################
#ELEMENTAL PLANES
...
##############################################################################################################################
    if($text=~/Access to Temple of Marr/i) {
      $client->Message(4,"To access the Temple of Marr, after you have killed Terris Thule, Saryrn, Bertox the Halls of Honor Trials, and all of the flags before this (further help, say [" . quest::saylink("unlock memories",0,"unlock memories") . "]), or say [" . quest::saylink("I am ready to access the Temple of Marr",0,"I am ready to access the Temple of Marr") . "].");
    }
...
##############################################################################################################################
    if($text=~/Access to Torment/i && (!defined $qglobals{pop_pod_alder_fuirstel} || !defined $qglobals{pop_pod_grimmus_planar_projection} || !defined $qglobals{pop_pod_elder_fuirstel} || !defined $qglobals{pop_pon_construct} || !defined $qglobals{pop_pon_hedge_jezith} || !defined $qglobals{pop_ponb_terris} || !defined $qglobals{pop_ponb_poxbourne} || !defined $qglobals{pop_cod_preflag} || !defined $qglobals{pop_cod_bertox} || !defined $qglobals{pop_cod_final})) {
      $client->Message(4,"To access the Plane of Torment, one must first defeat Terris Thule, Bertox, and all of the flags below them.  I am unable to find all of the required flags to allow you access to this plane currently.  Please check what you currently posess by using [" . quest::saylink("unlock memories",0,"unlock memories") . "]");
    }
    if($text=~/Access to Torment/i && defined $qglobals{pop_pod_alder_fuirstel} && defined $qglobals{pop_pod_grimmus_planar_projection} && defined $qglobals{pop_pod_elder_fuirstel} && defined $qglobals{pop_pon_construct} && defined $qglobals{pop_pon_hedge_jezith} && defined $qglobals{pop_ponb_terris} && defined $qglobals{pop_ponb_poxbourne} && defined $qglobals{pop_cod_preflag} && defined $qglobals{pop_cod_bertox} && defined $qglobals{pop_cod_final}) {
