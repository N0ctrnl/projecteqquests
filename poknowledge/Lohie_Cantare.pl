...
sub EVENT_SAY {
  if($text=~/Hail/i) {
    quest::say("Greetings, $name. Have you come to see my exhibit? I am honored but also sad to say it is incomplete. Mine will be the finest presentation of musical history you will find, once I finish assembling my display. If you have some free time, perhaps you could help me collect some still missing [" . quest::saylink("What pieces?",0,"pieces") . "]?");
  }
  if($text=~/pieces/i) {
    quest::say("'I need you to bring me a Minotaur Horn, Tambourine of Rituals, Orcish Lute of Singing, and a Stretched Skin Drum. If you could find these for me, I would be most overjoyed. You will need to get a Collector's Box from [" . quest::saylink("Who is Merri?",0,"Merri") . "] to keep them in. Close the box up tightly and return it to me once you have placed the instruments inside. Hurry back and we shall have a grand festival!");
  }
  if($text=~/merri/i) {
