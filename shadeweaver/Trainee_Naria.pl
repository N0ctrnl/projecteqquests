sub EVENT_SAY { 
  if($text=~/Hail/i){
    quest::say("Have you noticed the vicious Saurek [" . quest::saylink("What Shredders?",0,"Shredders") . "] out in the thicket? I wouldn't want to hunt one of those nasty things.");
  }
