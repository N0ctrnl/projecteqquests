sub EVENT_SAY { 
  if($text=~/Hail/i){
    quest::say("Well met $name. Pay close attention to Captain Tarief's words of advice. It takes a skillful hunter to kill a Saurek [" . quest::saylink("Who are the Darkclaw?",0,"Darkclaw") . "]. His advice could mean the difference between life and death.");
  }
