sub EVENT_SAY { 
  if($text=~/Hail/i){
    quest::say("It is an honor to meet a fellow hunter. I am training to learn how to hunt down the [" . quest::saylink("What saurek?",0,"saurek") . "] that roam the thicket. It is our duty as taruun to provide food for our kin. I plan on claiming Captain Tarief's [" . quest::saylink("What reward?",0,"reward") . "].");
  }
