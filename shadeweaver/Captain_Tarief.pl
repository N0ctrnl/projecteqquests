...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Well met, have you [" . quest::saylink("I have come to aid",0,"come to aid") . "] us in hunting the hoppers of the thicket?");
  }
  if ($text=~/come to aid/i) {
    quest::say("If you are preparing to hunt, then there are a few things you should know. Some of the hoppers have unique abilities. Knowledge of these abilities can mean the difference between life and death. I will tell you a little bit about them if you [" . quest::saylink("I wish to listen",0,"wish to listen") . "].");
  }
  if ($text=~/wish to listen/i) {
    quest::say("A wise choice, it is good to learn all that you can of the prey before initiating the hunt. Such a tactic is vital when you set out for larger game. Learn of your prey's strengths and weaknesses and you shall have the upper hand. Saureks may all seem similar to one another at first glance, but this is not the case. Such a mistake has left many Taruun dead. I have learned that the darkclaw saureks have venom dripping from their claws. There are a few other [" . quest::saylink("What unique qualities?",0,"unique qualities") . "] to the saureks as well.");
  }
