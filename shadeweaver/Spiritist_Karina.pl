...
sub EVENT_SAY {
  ...
  if($text=~/loda kai/i){
    quest::say("Loda Kai left Shar Vahl many years ago. He had set off for the distant city of Katta Castellum just north of the tenebrous mountains. We have not seen him since, but the brigands wear his family emblem. [" . quest::saylink("Who is Kedra Kai?",0,"Kedra Kai") . "] has banished himself from our city in shame.");
  }
  #Quest: Rotting Jawbones 
  if($text=~/kedra kai/i){
...
sub EVENT_ITEM {
  ...
  if (plugin::check_handin(\%itemcount, 30872 => 4)) {
    ...
    quest::say("I can see that you have a brave heart. You have rescued many of the fallen spirits with little regard to your own welfare. Such selfless acts should not go unrewarded. Please take these gloves and wear them with pride. It is a symbol of [" . quest::saylink("What rebirth?",0,"rebirth") . "].");
  ...
  #Handin: A Sharp Toothed Jawbone
    ...
    quest::say("I can sense the mark of the [" . quest::saylink("Who is Loda Kai?",0,"Loda Kai") . "] within these jawbones. This is a horror, for Loda Kai was once a member of my people. I do not know how he came about these strange magical forces but it can not be good news. Please wear these sleeves for protection. This new discovery worries me 
deeply.");
