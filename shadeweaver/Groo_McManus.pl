...
sub EVENT_SAY { 
if($text=~/Hail/i){
quest::say("Greetings adventure seeker. I have come from afar to study this strange thicket. The spirits are strong within this region, but they are secretive as well.  I am willing to impart my wisdom to those who will aid me in my exploration. Are you [" . quest::saylink("I am interested",0,"interested") . "]?");
}
...
sub EVENT_ITEM { 
  if(plugin::check_handin(\%itemcount, 30601 => 1)) {
    quest::say("Excellent! You have done well.  I can sense that you are in tune with the spirits around you. Take this, for you will need it in your next task. When you are [" . quest::saylink("I am ready",0,"ready") . "] for your next lesson let me know.");
