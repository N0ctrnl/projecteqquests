...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 28710,item2 = 28709,item3 = 28724,item4 = 28725})) then  -- Lock of Tangled Banshee Hair, Nightmare Hoof, Malarian Wing, Tattered Leperoth Clothing
		...
		e.self:Emote("echoes in your mind, 'Well done, you have proven yourself to us. Here is your reward. You may continue our tasks, if you are willing. You have already succeeded where few dare to try, you may [" .. eq.say_link("I wish to continue my service",false,"continue your service") .. "] to us, if you wish; however do not lose the trinket we gave you, you will need it to proceed.");
