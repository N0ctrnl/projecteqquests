...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Don't be bothered by that crazy gnome. He won't hurt you. He's just a little out of it today. I'm sure if he had some [" . quest::saylink("mushrooms") . "] it'd calm him down.");
  }
  if ($text=~/mushrooms/i) {
