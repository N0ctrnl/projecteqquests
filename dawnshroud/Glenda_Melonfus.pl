...
quest::say("Ahh. so you're interested in the Galorians then? Good to hear. The Galorians seem to be at war with the [" . quest::saylink("Dawnhoppers") . "]. The Galorians are known as the Sambata Tribe. I heard that they once lived in the caves behind us. but that all changed when the Dawnhoppers grew in numbers.'");
}
