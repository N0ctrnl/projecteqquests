function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Oooh.. Hello, [" .. eq.say_link("I am not a guard",false,"guard") .. "]. Please do not let the [" .. eq.say_link("What Teir'Dall?",false,"Teir'Dal") .. "] at me again. I can take no more.");
