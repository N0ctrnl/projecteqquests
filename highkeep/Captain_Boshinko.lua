...
function event_say(e)
	...
	if(e.message:findi("hail")) then
		e.self:Say("Greetings. stranger! Are you the [" .. eq.say_link("I am the bounty hunter you requested",false,"bounty hunter I requested") .. "]?");
