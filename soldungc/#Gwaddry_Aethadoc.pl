...
sub EVENT_SAY {
  if($text=~/Hail/i) {
    quest::say("Get out of my way mortal, you have no business with me unless you [" . quest::saylink("I wish disposal of the fire demons",0,"wish disposal of the fire demons") . "].");
  }
  if($text=~/wish disposal of the fire demons/i) {
    quest::say("Well then $name, you might be of service to me after all. I seek some brave soldiers to strike back at the servants of Nagafen that have been chosen to guard his hordes of treasure. They need to be cut down so that we may claim what is rightfully ours. Do you wish to [" . quest::saylink("I will strike back at the minions of Nagafen",0,"strike back at the minions of Nagafen") . "]");
  }
  if($text=~/strike back at the minions of nagafen/i) {
    quest::say("Very well, I will need you to collect me 4 items for an incantation I have been working on. My limited area that I am forced to reside in has prevented my practice of magic so I have been restricted to concocting alchemy potions. When you are [" . quest::saylink("I am ready",0,"ready") . "] I will have you [" . quest::saylink("I will gather the components",0,"gather the components") . "] I need for my potion.");
  }
  ...
  if($text=~/bigger problem/i) {
    quest::say("I do feel that you have no problem assisting me with any items I may need, but what I am about to ask you to do could put my life in jeopardy. Let me begin by telling you how I lost my sacred [" . quest::saylink("What family totem?",0,"family totem") . "].");
  }
  if($text=~/family totem/i) {
    quest::say("The totem I speak of has been in my family for 5 generations, that is until I lost it recently in a battle to hold back the forces of the Taklasinai. I wish to regain my totem so that I may use it to do the [" . quest::saylink("What is unspeakable?",0,"unspeakable") . "].");
  }
  if($text=~/unspeakable/i) {
    quest::say("For years I have sat here in this dwelling unable to practice my magic at the fault of the Vrodak. I no longer wish to be confined to this space and want to be free. The only way I will not die where I stand is to pledge allegiance to the Taklasinai. I feel if I seek council before their leaders they will agree to use my ranking as a way to infiltrate the Vrodak defenses and eventually cause the Vrodak clan to crumble. Before I can free myself I will need my magical family artifact. If you will [" . quest::saylink("I will collect the pieces of your totem",0,"collect the pieces of my totem") . "] I will reward you greatly.");
  }
...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 61230 => 1, 61231 => 1, 61232 => 1, 61233 => 1)) {#Fireback Silk, Sweltering Slime Bauble, Fireborn Tooth, Blistering Tentacle
    quest::say("Well I see that you can certainly be trusted to uphold my will should I request it of you. Please take this symbol and return to me if you should desire to help me with a much [" . quest::saylink("What bigger problem?",0,"bigger problem") . "].");
