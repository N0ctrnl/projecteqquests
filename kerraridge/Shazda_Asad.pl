...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Rrrr..I am  Asad. Shazda of the Kerran [" . quest::saylink("What is the Sejah?",0,"Sejah") . "]. It is my duty to ensure the safety of what lands have not been taken from us by the Erudites, and to train my soldiers in the fighting styles of our heritage.");
  }
  if ($text=~/sejah/i) {
