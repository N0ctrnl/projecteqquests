...
sub EVENT_SAY {
  if($text=~/Hail/i) {
    quest::say("Wha?  Rarrrr!  Thalith try to fish but with [" . quest::saylink("What rrrats?",0,"rrrats") . "] and you botherring him. he cannot concentrate on water!  Go away. let Thalith fish!");
  }
  if ($text=~/rats/i) {
