...
sub EVENT_SAY {
  ...
  if ($text=~/prove myself worthy/i && $faction == 1 && $qglobals{galeweaver} == 1){
    quest::say("Then your endeavor shall continue, my child. Take this scroll -- to you now it holds no meaning but in due time you shall understand. Keep the scroll close to you until you have sought and successfully acquired the [" . quest::saylink("What Dormant Crystal Sphere?",0,"Dormant Crystal Sphere") . "] and [" . quest::saylink("What about The Rainkeeper's Writ?",0,"The Rainkeeper's Writ") . "].");
    quest::summonitem(8962); # Item: Ancient White Scroll
  }
  if ($text=~/dormant crystal sphere/i && $qglobals{galeweaver} == 1) {
    quest::say("There are several magical spheres throughout Norrath but this sphere is [" . quest::saylink("unique to The Rainkeeper") . "]. It is said that when Karana blessed this area with his first storm in acceptance of the nomadic tribe that would settle here, that the droplets of rain left upon the pines and blades of grass was gathered by one of these nomads and stored in a plain clay jar that was then buried as a symbol of their own gratitude toward the storm. Nearly a century later when Karana's Shrine and the Throne of Karana's Thunder were near completion, one known as Tanirun Galeweaver found the jar. The water was still inside, preserved by means unexplainable through simple reason. It is said that Tanirun poured the water into his own hands and wove a spell, sealing the wind within the orb of this ancient rain that was now crystallized by Tanirun's spell.");
  }
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 8956 => 1) && $faction == 1){ #Idol of karana
    quest::say("Marvelously done, my friend. The idol's return by your hand bodes well indeed toward the success of your quest. Now, it shall remain without a hand to possess it -- but in time, perhaps, it may find a suitable possessor in you. If [" . quest::saylink("I wish to prove myself worthy",0,"you wish to prove yourself worthy") . "] of the idol and further prove your faith as notable enough to belong to the sacred order of The Gale Weavers, then speak your pledge and your test shall continue.");
    quest::exp(10000);
    quest::ding();
