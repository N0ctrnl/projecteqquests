...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hail, " .. e.other:GetCleanName() .. ". You have nothing to fear from the gnolls. My men and I have been sent from Qeynos to help defend Fort Jaggedpine should those worthless curs make the mistake of assuming this will be a place of easy plunder. I've fought and slain scores of gnolls in my time. Were I not bound to my post here I would go forth and drive them from their dark cave to the north myself. However, I can offer you a [" .. eq.say_link("What bounty?",false,"bounty") .. "], should you choose to take such a mission upon yourself.");
	elseif(e.message:findi("bounty")) then
		e.self:Say("If you choose to go and fight against the gnolls, I shall offer a bounty for every gnoll canine that you return to me. You look a bit more adventurous then many of those that live in this settlement. They seem a bit [" .. eq.say_link("Are you sure they are docile?",false,"docile") .. "].");
	elseif(e.message:findi("docile")) then
		e.self:Say("Perhaps it comes from living in harmony with nature for an extended period of time but they are more concerned with trading food recipes and doing arts and crafts. I have offered to give them some basic training in the arts of war but they seem to have no interest. This is a dangerous world in which we live and failure to acknowledge that has meant the downfall of many a society. I won't let this happen on my watch, provided my [" .. eq.say_link("Who are your men?",false,"men") .. "] are on their toes.");
	elseif(e.message:findi("men")) then
		e.self:Say("Guard Bossamir is a model soldier and a good man. I'm happy to have him watching my back. That Finewine character however, he is not worth the cost of the sword he wields! All he does is whine and complain. He was born with a silver spoon in his mouth and his family enrolled him in the guard to teach him some discipline but I've had no luck with him. He hasn't even turned in a [" .. eq.say_link("Why hasn't he turned in a shift report?",false,"shift report") .. "] for weeks. Captain Tillin will bust me down to private if I don't deliver those soon.");
