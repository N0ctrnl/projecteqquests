...
if ($faction == 1) {
  if (plugin::check_handin(\%itemcount, 8907 => 1)){ #Tome of Thunder from an unkempt fanatic
    quest::emote("examines the tome carefully, running his callused hands over the cover and spine and flipping through the ancient parchement within, 'Yes...nicely done, child. It is in miraculous condition for the recent fate that befell it. I am indebted to you and have the noblest intentions to repay your efforts. However, whilst you were away, my smithy was raided and most of my needed supplies to create the item I think a suitable reward for your efforts were stolen by the poachers. I will need to retrieve one of the [" . quest::saylink("What key materials?",0,"key materials") . "] and take it with the Writ of Thunder to my assistant, Gurrin Nitestorm who you may find in the Surefall Glade.'");
    quest::exp(1000);
    quest::ding();
