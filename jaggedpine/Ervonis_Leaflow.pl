...
sub EVENT_SAY {
  if($text=~/lost/i && $germand == 1){
    quest::say("I was washing its fine blade down by the river when those darned potameids attacked me. I ran but left my axe behind out of pure fear. If you could [" . quest::saylink("I will find it",0,"find") . "] it, I would be grateful and won't even charge you for some wood."); 
  }
