sub EVENT_SAY {
  if (($langid == 22) && ($client->GetLanguageSkill(22) == 100)) { #Elder Dragon
    if ($text=~/hail/i) {
      quest::say("'Mortal. . .' He flaps his wings and a talon taps against the floor, making a sharp noise in the silence. 'Mortal. . . time is short. If you can understand me, perhaps you can help me. I need my grimoire, my tome, the source of my power. With help from the [" . quest::saylink("What distant ones?",0,"distant ones") . "], I can make my escape.'", 22); #Elder Dragon
    }
