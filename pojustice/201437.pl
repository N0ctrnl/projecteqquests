...
sub EVENT_SAY {
  if(defined $qglobals{pop_poj_mavuin}) {
    if($text=~/Hail/i) {
      ...
      quest::say("Very well. When you are ready, you may [" . quest::saylink("I am ready to begin the trial of stoning",0,"begin the trial of stoning") . "]. The archers will not cease their punishment until nothing else stands. Do not let the prisoners take more than they can bear. We shall judge the mark of your success.");
