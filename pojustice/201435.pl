...
sub EVENT_SAY {
  if(defined $qglobals{pop_poj_mavuin}) {
    if($text=~/Hail/i) {
      quest::emote(" fixes you with a dark, peircing gaze. 'What do you want, mortal? Are you [" . quest::saylink("I am prepared",0,"prepared") . "]?");
    } elsif($text=~/prepared/i) {
      quest::say("Very well. When you are ready, you may [" . quest::saylink("I am ready to begin the trial of lashing",0,"begin the trial of lashing") . "]. You must protect the victims from their tormentors. Be wary of the scourge of honor - you cannot fight it directly. You must find and destroy its life force to defeat it. We shall judge the mark of your success.");
