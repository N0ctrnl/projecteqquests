...
sub EVENT_SAY {
  if(defined $qglobals{pop_poj_mavuin}) {
    if($text=~/Hail/i) {
      ...
      quest::say("Very well. When you are ready, you may [" . quest::saylink("I amr eady to begin the trial of hanging",0,"begin the trial of hanging") . "]. Act quickly to destroy the spirits of suffocation before their victims perish. We shall judge the mark of your success.");
