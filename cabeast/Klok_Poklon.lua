function event_say(e)
	...
	elseif(e.message:findi("What memory of Sebilis?")) then
		e.self:Emote("takes a sip of Legion Lager. 'Puhh...lease!! That's the little trophy the War Baron brought back from Sebilis. He got it stolen from him by some thieves!! I say it was the [" .. eq.say_link("Steelhead Gang") .. "]. They were waltzing in and out of Cabilis like it was a blasted public vomitorium!!'");
