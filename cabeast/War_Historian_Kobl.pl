sub EVENT_SAY { 
if($text=~/Hail/i){
quest::say("You have come to learn. have you not?  I have knowledge of importance to young warriors of the legion.  Or perhaps you are a scribe seeking my [" . quest::saylink("unique writing materials") . "]!");
}
if($text=~/what unique writing materials/i){
quest::say("You must be a scribe of sorts?  Always glad to assist a talented youth.  I make two things unique to Cabilis and important to any future master scribe.  I can create [" . quest::saylink("blood ink") . "] and [" . quest::saylink("illweed parchment") . "].");
}
