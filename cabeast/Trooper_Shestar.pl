...
sub EVENT_SAY {
  if($text=~/Hail/i){
    quest::say("My father was a great blacksmith.  He taught me how to make great items such as the [" . quest::saylink("Shestar scaled coif") . "].  Alas, smithing was not my rebirth, but rather the life of a warrior.");
  }
