...
function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Emote("seems to be preocupied. He is examining an egg. 'What?!! Who has [" .. eq.say_link("sent") .. "] you to me? Bah!! Away with you.' He ignores you and continues chanting.'");
	elseif(e.message:findi("sent")) then
		e.self:Emote("drops the egg he was holding. Egg yolk splatters on your foot. His eyes roll back into his head. He speaks, but his voice is that of a female. 'I await you, " .. e.other:GetCleanName() .. " . My sisters and I yearn for the return of our skulls. We are the [" .. eq.say_link("Sisters of Scale") .. "]. Find us and bring to this hierophant our skulls and your iron cudgel of the Channeler. Go.'");
	elseif(e.message:findi("Zand") and (e.other:GetFaction(e.self) <= 4)) then
		e.self:Say("I await you, " .. e.other:GetCleanName() .. " . My sisters and I yearn for the return of our skulls. We are the [" .. eq.say_link("Sisters of Scale") .. "]. Find us and bring to this hierophant our skulls and your iron cudgel of the Channeler. Go.");
