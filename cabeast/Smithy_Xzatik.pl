sub EVENT_SAY { 
if($text=~/Hail/i){
quest::say("Greetings. $name! I have the finest Skyiron Ores for sale! Feel free to examine the quality of my ores! I am also charged with teaching members of the Legion techniques to [" . quest::saylink("work Skyiron") . "]. craft [" . quest::saylink("Skyiron Targ Shields") . "] and [" . quest::saylink("Cabilis Scale Mail") . "].");
}
if($text=~/what cabilis scale mail?/i){
quest::say("Cabilis Scale Mail is a customized armor worn by the Legion of Cabilis. The mail can only be forged in the unique Cabilis Forge here in East Cabilis. All pieces of the mail require the appropriate section Mold and a Flask of Blood Water. Coifs. Masks. Gorgets. Mantles. Belts. and Bracelets require one Skyiron Sheet. and one set of Skyiron Scales. Gloves and Boots require Two Skyiron Sheets and one set of Skyiron Scales. Sleeves require two Skyiron Sheets and two sets of Skyiron Scales. Coats. Cloaks. and Leggings require three Skyiron Sheets. and two sets of Skyiron Scales. Once you have mastered these techniques you may want to try [" . quest::saylink("imbued mail") . "].");
}
