...
sub EVENT_SAY { 
  if($text=~/Hail/i){
    quest::say("Hello, $name. This place is quite a formidable outpost, but it lacks the comforts of home. Once I have finished collecting some of my [" . quest::saylink("What missing scrolls?",0,"missing scrolls") . "], I'll be able to leave this place and all its hidden dangers.");
  }
