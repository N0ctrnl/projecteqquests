...
sub EVENT_SAY {
  if($text =~ /Hail/i){
    quest::say("Ahh, welcome! More souls to succumb to the inhabitants of the Outlands! My army of undead will grow stronger by the day, but it would be a pity if you perished before doing a [" . quest::saylink("I will do your mortal bidding",0,"mortal bidding") . "] for me.");
  }
