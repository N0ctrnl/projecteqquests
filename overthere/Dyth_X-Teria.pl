...
sub EVENT_SAY { 
  if($text=~/Hail/i){
    ...
    quest::say("Speak!! I am dispatched from Neriak to this land by order of the king. I shall research [" . quest::saylink("What new spells?",0,"new spells") . "] and aid the adventuring wizards. My knowledge of wizardry is offered to all in hopes of gaining information about Kunark.");
  }
  if ($text=~/new spells/i) {
    quest::say("Within this lost land could lie the knowledge of extinct civilizations. I am ordered to seek out this knowledge for the empire of Neriak. So far, all I have discovered is a way to create a spell of my own design. I call it [" . quest::saylink("What is Brain Bite?",0,"Brain Bite") . "].");
  }
  if ($text=~/brain bite/i) {
    quest::say("If you wish to own a copy of MY spell, Brain Bite, I would be glad to give you one. All I ask is that you [" . quest::saylink("I will gather a few souls",0,"gather a few souls") . "] for me.");
  }
  if ($text=~/gather a few souls/i) {
    quest::emote("reveals three ornate bottles.");
    quest::say("While I finished my research on Brain Bite, I encountered three [" . quest::saylink("What interlopers?",0,"interlopers") . "] who wished to steal my spell. I had the dragoon garrison track them down and dispatch them. Unfortunately, I forgot to instruct them to trap their souls with these bottles. Do you want to [" . quest::saylink("I will take the bottles",0,"take the bottles") . "] and finish the job?");
  }
