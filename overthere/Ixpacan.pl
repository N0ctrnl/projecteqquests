...
sub EVENT_SAY {
  if($text=~/hail/i) {
    quest::say("Hmm. . .is there something I can help you with? I am far too [" . quest::saylink("Why are you busy?",0,"busy") . "] to listen to your problems though so I take that back.");
  }
  if($text=~/busy/i) {
  ...
  if($text=~/wish to hear/i && $skullcap == 1) {
    quest::say("I have recently found a volume on summoning a great minion from the Great Library of Charasis but I can't find all of the needed items. Being as I am one of the [" . quest::saylink("What are the sages of Cabilis?",0,"sages of Cabilis") . "], I request you go and [" . quest::saylink("I will collect these items",0,"collect these items") . "] for me.");
  }
...
sub EVENT_ITEM {
  ...
  if (plugin::check_handin(\%itemcount, 4267 => 1)) {
    ...
    quest::say("Oh, I see you are truly gifted in the dark arts. Well I will explain my dilemma to you now if you [" . quest::saylink("I wish to hear",0,"wish to hear") . "].");
  }
