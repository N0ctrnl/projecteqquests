...
sub EVENT_SAY {
  if($text=~/hail/i){
    quest::say("Greetings friend, it is good to be freed from the clutches of those evil creatures. Tell me are you willing to help me bring some [" . quest::saylink("I will help you bring some justice",0,"justice") . "] to them?");
  }
  if($text=~/justice/i){
