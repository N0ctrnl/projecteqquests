...
sub EVENT_SAY {
  if($text=~/hail/i) {
    quest::say("Ahh. hello there $name. I am a trader from Sanctus Seru trying to make my way to Shadowhaven for some dealings. I have come this far with the aid of guards from Sanctus Seru, but they have turned back and left me to go on my own. I hear there are many terrible [" . quest::saylink("What creatures?",0,"creatures") . "] here lurking in the shadows. Leave it to the guards of the Hand to leave me unprotected.");
  }
  if($text=~/creatures/i) {
    quest::say("What I was told is that this pass is filled with small horrible creatures with no eyes. Perhaps you could [" . quest::saylink("I will help by providing safe passage",0,"help by providing safe passage") . "] to the other side?");
  }
