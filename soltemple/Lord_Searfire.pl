...
sub EVENT_SAY { 
   ...
   if($text=~/ronium/i) {
      quest::say("You seek ronium.  It is a fine blend of metals.  I alone hold the secret of its formula.  I, and I alone, can offer it to those who serve this temple.  Do you wish a [" . quest::saylink("I wish a bar of the alloy",0,"bar of the alloy") . "]?");
   }
