...
sub EVENT_SAY {
  if($text=~/hail/i) {
    quest::say("I am Joyce of the Temple of Solusek Ro. I am the guardian of four of the items of the elementalist. If you are a magician, ask me about the [" . quest::saylink("What about the Robe of the Elements?",0,"Robe of the Elements") . "], the [" . quest::saylink("What about the Clay Bracelet?",0,"Clay Bracelet") . "], the [" . quest::saylink("What about the Earthen Boots?",0,"Earthen Boots") . "] or the [" . quest::saylink("What about the Circlet of Mist?",0,"Circlet of Mist") . "]");
  }
  if($text=~/circlet of mist/i) {
    quest::say("The Circlet of Mist is a beautiful hoop that would look good atop your head. It produces a fine gleam, and is known to increase your mental power. Are you [" . quest::saylink("I am interested in the circlet",0,"interested in the circlet") . "]?");
  }
  ...
  if($text=~/clay bracelet/i) {
    quest::say("The clay bracelet is a wonderful piece of jewelry to wear on your wrist. It provides fine protection, enhances your resistance to magic, and lets you call forth a mystic eye to help you in your travels. Are you [" . quest::saylink("I am interested in the bracelet",0,"interested in the bracelet") . "]?");
  }
  ...
  if($text=~/earthen boots/i) {
    quest::say("Earthen Boots are a fine adornment for the feet of any Magician. They have a wonderful brown color, and are known to enhance the stamina of any Magician who wears them. As an added bonus, animals do not tend to notice those who wear Earthen Boots. Are you [" . quest::saylink("I am interested in the boots",0,"interested in the boots") . "]?");
  }
  ...
  if($text=~/robe of the elements/i) {
    quest::say("The Robe of the Elements is a fine cloak for a Magician. It provides protection from the elements, protection from melee attacks and aids the Magician with her focus. Are you [" . quest::saylink("I am interested in the robe",0,"interested in the robe") . "]?");
  }
