...
sub EVENT_SAY {
  if($text=~/Hail/i){
    quest::say("Welcome! I am Vurgo, follower of Solusek Ro and holder of the [" . quest::saylink("What harvester?",0,"harvester") . "] and the [" . quest::saylink("What Words of Darkness?",0,"Words of Darkness") . "].");
  }
  if($text=~/what harvester/i){
    quest::say("I can forge you one, but you will need to bring me the correct [" . quest::saylink("What scythe components?",0,"scythe components") . "].");
  }
  ...
  if($text=~/what words of darkness/i){
    quest::say("I can scribe for you the Words of Darkness, but you will need to bring me the correct [" . quest::saylink("What word components?",0,"word components") . "].");
  }
