...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("I am Romar Sunto, servant of Solusek Ro. I am searching for the [" .. eq.say_link("What coin?",false,"Coin") .. "] of the mighty enchanter [" .. eq.say_link("Who is Tash?",false,"Tash") .. "] - if you are interested in helping me acquire it, I will [" .. eq.say_link("What reward?",false,"reward") .. "] you with a powerful spell. I am also dispenser of [" .. eq.say_link("What Darkwood Staves?",false,"Darkwood Staves") .. "] - sometimes also called the Staff of Ro.");
